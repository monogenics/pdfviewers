          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof J || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || R(t, D, E(1, {})), (t[D][n] = !0)), H(t, n, r)) : R(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), F = [], P = 1; P < b.length; P++) F.push(void 0 === (x = b[P]) ? x : String(x));
            var M = b.groups;
            if (h) {
                ...
                switch ((g.prev = g.next)) {
                  case 0:
                    return (
                      (g.prev = 0),
                      (t = '../TestFiles/'),
                      'BusinessCardTemplate.pdf',
                      (r = 'BusinessCard.pdf'),
                      (g.next = 6),
                      regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'BusinessCardTemplate.pdf'))
                    );
                  case 6:
                    return (e = g.sent).initSecurityHandler(), e.lock(), (g.next = 11), regeneratorRuntime.awrap(n.ContentReplacer.create());
                  case 11:
                    return (o = g.sent), (g.next = 14), regeneratorRuntime.awrap(e.getPage(1));
                  case 14:
                    return (i = g.sent), (g.next = 17), regeneratorRuntime.awrap(n.Image.createFromURL(e, t + 'peppers.jpg'));
                  case 17:
                    return (u = g.sent), (g.next = 20), regeneratorRuntime.awrap(i.getMediaBox());
                  case 20:
                    return (c = g.sent), (g.next = 23), regeneratorRuntime.awrap(u.getSDFObj());
                  case 23:
                    return (a = g.sent), (g.next = 26), regeneratorRuntime.awrap(o.addImage(c, a));
                  case 26:
                    return (g.next = 28), regeneratorRuntime.awrap(o.addString('NAME', 'John Smith'));
                  case 28:
                    return (g.next = 30), regeneratorRuntime.awrap(o.addString('QUALIFICATIONS', 'Philosophy Doctor'));
                  case 30:
                    return (g.next = 32), regeneratorRuntime.awrap(o.addString('JOB_TITLE', 'Software Developer'));
                  case 32:
                    return (g.next = 34), regeneratorRuntime.awrap(o.addString('ADDRESS_LINE1', '#100 123 Software Rd'));
                  case 34:
                    return (g.next = 36), regeneratorRuntime.awrap(o.addString('ADDRESS_LINE2', 'Vancouver, BC'));
                  case 36:
                    return (g.next = 38), regeneratorRuntime.awrap(o.addString('PHONE_OFFICE', '604-730-8989'));
                  case 38:
                    return (g.next = 40), regeneratorRuntime.awrap(o.addString('PHONE_MOBILE', '604-765-4321'));
                  case 40:
                    return (g.next = 42), regeneratorRuntime.awrap(o.addString('EMAIL', 'info@pdftron.com'));
                  case 42:
                    return (g.next = 44), regeneratorRuntime.awrap(o.addString('WEBSITE_URL', 'http://www.pdftron.com'));
                  case 44:
                    return (g.next = 46), regeneratorRuntime.awrap(o.process(i));
                  case 46:
                    return (g.next = 48), regeneratorRuntime.awrap(e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused));
                  case 48:
                    (f = g.sent), saveBufferAsPDFDoc(f, r), console.log('Done. Result saved in ' + r), (g.next = 56);
                    break;
                  case 53:
                    (g.prev = 53), (g.t0 = g.catch(0)), console.log(g.t0);
                  case 56:
                    return (
                      (g.prev = 56), '../TestFiles/', 'newsletter.pdf', (s = 'ContentReplaced.pdf'), (g.next = 62), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf'))
                    );
                  case 62:
                    return (l = g.sent).initSecurityHandler(), l.lock(), (g.next = 67), regeneratorRuntime.awrap(n.ContentReplacer.create());
                  case 67:
                    return (p = g.sent), (g.next = 70), regeneratorRuntime.awrap(l.getPage(1));
                  case 70:
                    return (h = g.sent), (g.next = 73), regeneratorRuntime.awrap(h.getMediaBox());
                  case 73:
                    return (v = g.sent), (g.next = 76), regeneratorRuntime.awrap(p.addText(v, 'The quick onyx goblin jumps over the lazy dwarf'));
                  case 76:
                    return (g.next = 78), regeneratorRuntime.awrap(p.process(h));
                  case 78:
                    return (g.next = 80), regeneratorRuntime.awrap(l.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused));
                  case 80:
                    (y = g.sent), saveBufferAsPDFDoc(y, s), console.log('Done. Result saved in ' + s), console.log('Done.'), (g.next = 89);
                    break;
                  case 86:
                    (g.prev = 86), (g.t1 = g.catch(56)), console.log(g.t1);
                  case 89:
                  case 'end':
                    return g.stop();
                }
