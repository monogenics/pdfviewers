    ...
    (r = window.PDFNet),
      (e = function(t) {
        var n = readerControl.docViewer,
          e = n.getAnnotationManager(),
          o = e.getAnnotationsList(),
          i = n.getDocument();
        return r
          .initialize()
          .then(function() {
                  ...
                  function(a) {
                    for (;;)
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (a.next = 2), regeneratorRuntime.awrap(r.FDFDoc.createFromXFDF(o));
                        case 2:
                          return (t = a.sent), (a.next = 5), regeneratorRuntime.awrap(e.getPageIterator());
                        case 5:
                          n = a.sent;
                        case 6:
                          return (a.next = 8), regeneratorRuntime.awrap(n.hasNext());
                        case 8:
                          if (!a.sent) {
                            a.next = 41;
                            break;
                          }
                          return (a.prev = 9), (a.next = 12), regeneratorRuntime.awrap(n.current());
                        case 12:
                          return (i = a.sent), (a.next = 15), regeneratorRuntime.awrap(i.getNumAnnots());
                        case 15:
                          c = a.sent;
                        case 16:
                          if (!(c > 0)) {
                          ...
                          return (a.next = 19), regeneratorRuntime.awrap(i.getAnnot(--c));
                        case 19:
                          return (u = a.sent), (a.next = 22), regeneratorRuntime.awrap(u.getType());
                        case 22:
                          (a.t0 = a.sent),
                            (a.next =
                              a.t0 === r.Annot.Type.e_Widget
                                ? 25
                                : a.t0 === r.Annot.Type.e_Link
                                ? 25
                                : a.t0 === r.Annot.Type.e_Sound
                                ? 25
                                : a.t0 === r.Annot.Type.e_Movie
                                ? 25
                                : a.t0 === r.Annot.Type.e_FileAttachment
                                ? 25
                                : 26);
                          break;
                        case 25:
                        ...
                        case 26:
                          return i.annotRemoveByIndex(c), a.abrupt('break', 28);
                        case 28:
                          a.next = 16;
                          break;
                        case 30:
                          ...
                          break;
                        case 32:
                          return (a.prev = 32), (a.t1 = a.catch(9)), console.log('Error Removing Annotations: ' + a.t1), (a.next = 37), regeneratorRuntime.awrap(i.getSDFObj());
                        case 37:
                          a.sent.erase('Annots');
                        case 38:
                          n.next(), (a.next = 6);
                          break;
                        case 41:
                          return (a.next = 43), regeneratorRuntime.awrap(e.fdfMerge(t));
                        case 43:
                          return (a.next = 45), regeneratorRuntime.awrap(e.flattenAnnotations());
                        case 45:
                          return (a.next = 47), regeneratorRuntime.awrap(e.saveMemoryBuffer(r.SDFDoc.SaveOptions.e_linearized));
                        case 47:
          ...
          .then(function(t) {
            return e.deleteAnnotations(o), n.refreshAll(), n.updateView(), n.getDocument().refreshTextData(), t;
          });
      }),
      window.addEventListener('documentLoaded', function() {
        readerControl.docViewer.getDocument().getFileData = e;
      });
  },
]);
