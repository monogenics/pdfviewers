!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Ct),
        h(Vt, yt, Ct.values),
        v(Vt, { slice: kt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        At(Vt, 'buffer', 'b'),
        At(Vt, 'byteOffset', 'o'),
        At(Vt, 'byteLength', 'l'),
        At(Vt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Rt(v, r) : jt.call(v, r);
                  (i = r), (p = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      var m,
        ...
        R = ('Array' == n && E.entries) || P;
      if (
        (R && (x = s(R.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((F = !0),
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(R) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      I = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: F(0, !1) }))) : (i(t, D) || I(t, D, F(1, {})), (t[D][n] = !0)), q(t, n, r)) : I(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            var M = b.groups;
            if (h) {
              var R = [F].concat(P, E, p);
              void 0 !== M && R.push(M);
              var A = String(n.apply(void 0, R));
            } else A = y(F, p, E, P, M, n);
            E >= w && ((S += p.slice(w, E) + A), (w = E + F.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n) {
    !(function(t) {
      t.runDigitalSignaturesTest = function() {
        var n = t.PDFNet,
          r = function() {
            var t, r, e, o, i, u, c, a, f, s, l, p, h, v, y, g;
                  ...
                  switch ((d.prev = d.next)) {
                    case 0:
                      return (
                        ...
                        (t = '../TestFiles/pdftron.pfx'),
                        (r = '../TestFiles/signature.jpg'),
                        (e = !0),
                        (d.prev = 4),
                        console.log('Signing PDF document: '),
                        (d.next = 8),
                        regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/doc_to_sign.pdf'))
                      );
                    case 8:
                      return (
                        (o = d.sent).initSecurityHandler(),
                        o.lock(),
                        console.log('PDFNet and PDF document initialized and locked'),
                        (d.next = 14),
                        regeneratorRuntime.awrap(o.addStdSignatureHandlerFromURL(t, 'password'))
                      );
                    case 14:
                      return (i = d.sent), (d.next = 17), regeneratorRuntime.awrap(o.getField('Signature1'));
                    case 17:
                      return (u = d.sent), (d.t0 = regeneratorRuntime), (d.t1 = n.WidgetAnnot), (d.next = 22), regeneratorRuntime.awrap(u.getSDFObj());
                    case 22:
                      return (d.t2 = d.sent), (d.t3 = d.t1.createFromObj.call(d.t1, d.t2)), (d.next = 26), d.t0.awrap.call(d.t0, d.t3);
                    case 26:
                      return (c = d.sent), (d.next = 29), regeneratorRuntime.awrap(u.useSignatureHandler(i));
                    case 29:
                      return (a = d.sent), (d.next = 32), regeneratorRuntime.awrap(a.putString('Name', 'PDFTron'));
                    case 32:
                      return (d.next = 34), regeneratorRuntime.awrap(a.putString('Location', 'Vancouver, BC'));
                    case 34:
                      return (d.next = 36), regeneratorRuntime.awrap(a.putString('Reason', 'Document verification.'));
                    case 36:
                      return (d.next = 38), regeneratorRuntime.awrap(n.ElementWriter.create());
                    case 38:
                      return (f = d.sent), (d.next = 41), regeneratorRuntime.awrap(n.ElementBuilder.create());
                    case 41:
                      return (s = d.sent), f.begin(o), (d.next = 45), regeneratorRuntime.awrap(n.Image.createFromURL(o, r));
                    case 45:
                      return (l = d.sent), (d.next = 48), regeneratorRuntime.awrap(l.getImageWidth());
                    case 48:
                      return (p = d.sent), (d.next = 51), regeneratorRuntime.awrap(l.getImageHeight());
                    case 51:
                      return (h = d.sent), (d.next = 54), regeneratorRuntime.awrap(s.createImageScaled(l, 0, 0, p, h));
                    case 54:
                      return (v = d.sent), f.writePlacedElement(v), (d.next = 58), regeneratorRuntime.awrap(f.end());
                    case 58:
                      return (
                        (y = d.sent).putRect('BBox', 0, 0, p, h),
                        y.putName('Subtype', 'Form'),
                        y.putName('Type', 'XObject'),
                        f.begin(o),
                        (d.next = 65),
                        regeneratorRuntime.awrap(s.createFormFromStream(y))
                      );
                    case 65:
                      return (v = d.sent), f.writePlacedElement(v), (d.next = 69), regeneratorRuntime.awrap(f.end());
                    case 69:
                      return (y = d.sent).putRect('BBox', 0, 0, p, h), y.putName('Subtype', 'Form'), y.putName('Type', 'XObject'), (d.next = 75), regeneratorRuntime.awrap(c.setAppearance(y));
                    case 75:
                      return (d.next = 77), regeneratorRuntime.awrap(c.refreshAppearance());
                    case 77:
                      return (d.next = 79), regeneratorRuntime.awrap(o.saveMemoryBuffer(0));
                    case 79:
                      (g = d.sent), saveBufferAsPDFDoc(g, 'signed_doc.pdf'), console.log('Finished signing PDF document'), (d.next = 87);
                      break;
                    case 84:
                      (d.prev = 84), (d.t4 = d.catch(4)), console.log(d.t4);
                    case 87:
          ...
          e = function() {
            var t, r, e, o, i, u, c, a, f, s, l, p, h, v, y;
            return regeneratorRuntime.async(
              function(g) {
                for (;;)
                  switch ((g.prev = g.next)) {
                    case 0:
                      return (
                        (t = '../TestFiles/newsletter.pdf'),
                        (r = '../TestFiles/pdftron.pfx'),
                        (e = !0),
                        (g.prev = 3),
                        console.log('Certifying PDF document: "' + t + '"'),
                        (g.next = 7),
                        regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t))
                      );
                    case 7:
                      return (o = g.sent).initSecurityHandler(), o.lock(), (g.next = 12), regeneratorRuntime.awrap(o.addStdSignatureHandlerFromURL(r, 'password'));
                    case 12:
                      return (i = g.sent), (g.next = 15), regeneratorRuntime.awrap(o.fieldCreate('Signature1', n.Field.Type.e_signature));
                    case 15:
                      return (u = g.sent), (g.next = 18), regeneratorRuntime.awrap(o.getPage(1));
                    case 18:
                      return (c = g.sent), (g.t0 = regeneratorRuntime), (g.t1 = n.WidgetAnnot), (g.next = 23), regeneratorRuntime.awrap(o.getSDFDoc());
                    case 23:
                      return (g.t2 = g.sent), (g.next = 26), regeneratorRuntime.awrap(n.Rect.init(0, 0, 0, 0));
                    case 26:
                      return (g.t3 = g.sent), (g.t4 = u), (g.t5 = g.t1.create.call(g.t1, g.t2, g.t3, g.t4)), (g.next = 31), g.t0.awrap.call(g.t0, g.t5);
                    case 31:
                      return (a = g.sent), c.annotPushBack(a), a.setPage(c), (g.next = 36), regeneratorRuntime.awrap(a.getSDFObj());
                    case 36:
                      return (f = g.sent).putNumber('F', 132), f.putName('Type', 'Annot'), (g.next = 41), regeneratorRuntime.awrap(u.useSignatureHandler(i));
                    case 41:
                      return (
                        (s = g.sent).putName('SubFilter', 'adbe.pkcs7.detached'),
                        s.putString('Name', 'PDFTron'),
                        s.putString('Location', 'Vancouver, BC'),
                        s.putString('Reason', 'Document verification'),
                        (g.next = 48),
                        regeneratorRuntime.awrap(o.getRoot())
                      );
                    case 48:
                      return (l = g.sent), (g.next = 51), regeneratorRuntime.awrap(l.putDict('Perms'));
                    case 51:
                      return g.sent.put('DocMDP', s), (g.next = 55), regeneratorRuntime.awrap(s.putArray('Reference'));
                    case 55:
                      return (p = g.sent), (g.next = 58), regeneratorRuntime.awrap(p.pushBackDict());
                    case 58:
                      return (h = g.sent).putName('TransformMethod', 'DocMDP'), h.putName('Type', 'SigRef'), (g.next = 63), regeneratorRuntime.awrap(h.putDict('TransformParams'));
                    case 63:
                      return (v = g.sent).putNumber('P', 1), v.putName('Type', 'TransformParams'), v.putName('V', '1.2'), (g.next = 69), regeneratorRuntime.awrap(o.saveMemoryBuffer(0));
                    case 69:
                      (y = g.sent), saveBufferAsPDFDoc(y, 'newsletter_certified.pdf'), console.log('Finished certifying PDF document.'), (g.next = 77);
                      break;
                    case 74:
                      (g.prev = 74), (g.t6 = g.catch(3)), console.log(g.t6);
                    case 77:
          ...
          return regeneratorRuntime.async(function(n) {
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  return console.log('Beginning Test'), (t = !0), (n.next = 4), regeneratorRuntime.awrap(r());
                case 4:
                  if (n.sent) {
                    n.next = 6;
                    break;
                  ...
                  t = !1;
                case 6:
                  return (n.next = 8), regeneratorRuntime.awrap(e());
                case 8:
                  if (n.sent) {
                    n.next = 10;
                    break;
                  ...
                  t = !1;
                case 10:
                  t ? console.log('Done. All Tests Passed') : console.log('Tests Failed');
                case 11:
                case 'end':
                  return n.stop();
              }
