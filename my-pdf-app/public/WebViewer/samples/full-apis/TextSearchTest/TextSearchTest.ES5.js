!(function(t) {
        ...
        kt = {
          ...
          subarray: function(t, n) {
            var r = Mt(this),
              e = r.length,
              o = m(t, e);
            return new (R(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Lt = function(t, n) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: g ? P : S('keys'), entries: F }), d)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[R], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
    ...
    !(function(t) {
      t.runTextSearchTest = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, a, f, s, l, h, p, v, y, g, d, m;
          return regeneratorRuntime.async(
            function(b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  case 0:
                    return '../TestFiles/', 'credit card numbers.pdf', (b.prev = 2), (b.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/credit card numbers.pdf'));
                  case 5:
                    return (t = b.sent).initSecurityHandler(), t.lock(), (b.next = 10), regeneratorRuntime.awrap(n.TextSearch.create());
                  case 10:
                    (r = b.sent), (e = n.TextSearch.Mode.e_whole_word + n.TextSearch.Mode.e_page_stop), (o = 'joHn sMiTh'), r.begin(t, o, e), (i = 0);
                  case 15:
                    return (b.next = 18), regeneratorRuntime.awrap(r.run());
                  case 18:
                    if (((u = b.sent), (c = void 0), u.code !== n.TextSearch.ResultCode.e_found)) {
                      b.next = 125;
                      break;
                    }
                    if (0 !== i) {
                    ...
                    return console.log(u.out_str + "'s credit card number is: "), (b.next = 25), regeneratorRuntime.awrap(r.getMode());
                  case 25:
                    (e = b.sent), (e += n.TextSearch.Mode.e_reg_expression + n.TextSearch.Mode.e_highlight), r.setMode(e), (o = '\\d{4}-\\d{4}-\\d{4}-\\d{4}'), r.setPattern(o), ++i, (b.next = 123);
                    break;
                  case 33:
                    if (1 !== i) {
                      b.next = 53;
                    ...
                    console.log('  ' + u.out_str), (c = u.highlights).begin(t);
                  case 37:
                    return (b.next = 39), regeneratorRuntime.awrap(c.hasNext());
                  case 39:
                    if (!b.sent) {
                      b.next = 48;
                      break;
                    }
                    return (b.next = 42), regeneratorRuntime.awrap(c.getCurrentPageNumber());
                  case 42:
                    return (a = b.sent), console.log('The current highlight is from page: ' + a), (b.next = 46), regeneratorRuntime.awrap(c.next());
                  case 46:
                    b.next = 37;
                    break;
                  case 48:
                    (o = '\\d{4}-\\d{6}-\\d{5}'), r.setPattern(o), ++i, (b.next = 123);
                    break;
                  case 53:
                    if (2 !== i) {
                      b.next = 65;
                    ...
                    return console.log('\nThere is an AMEX card number:\n  ' + u.out_str), (b.next = 57), regeneratorRuntime.awrap(r.getMode());
                  case 57:
                    (e = b.sent), (e += n.TextSearch.Mode.e_search_up), r.setMode(e), (o = '[A-z]++ [A-z]++'), r.setPattern(o), ++i, (b.next = 123);
                    break;
                  case 65:
                    if (3 !== i) {
                      b.next = 123;
                    ...
                    return console.log("Is the owner's name:\n  " + u.out_str + '?'), (c = u.highlights), (b.next = 70), regeneratorRuntime.awrap(c.begin(t));
                  case 70:
                    return (b.next = 72), regeneratorRuntime.awrap(c.hasNext());
                  case 72:
                    if (!b.sent) {
                      b.next = 118;
                      break;
                    }
                    return (b.t0 = regeneratorRuntime), (b.t1 = t), (b.next = 77), regeneratorRuntime.awrap(c.getCurrentPageNumber());
                  case 77:
                    return (b.t2 = b.sent), (b.t3 = b.t1.getPage.call(b.t1, b.t2)), (b.next = 81), b.t0.awrap.call(b.t0, b.t3);
                  case 81:
                    return (f = b.sent), (b.next = 84), regeneratorRuntime.awrap(c.getCurrentQuads());
                  case 84:
                    (s = b.sent), (l = 0);
                  case 86:
                    if (!(l < s.length)) {
                    ...
                    return (
                      (h = s[l]),
                      (p = Math.min(Math.min(Math.min(h.p1x, h.p2x), h.p3x), h.p4x)),
                      (v = Math.max(Math.max(Math.max(h.p1x, h.p2x), h.p3x), h.p4x)),
                      (y = Math.min(Math.min(Math.min(h.p1y, h.p2y), h.p3y), h.p4y)),
                      (g = Math.max(Math.max(Math.max(h.p1y, h.p2y), h.p3y), h.p4y)),
                      (b.t4 = regeneratorRuntime),
                      (b.t5 = n.LinkAnnot),
                      (b.t6 = t),
                      (b.next = 97),
                      regeneratorRuntime.awrap(n.Rect.init(p, y, v, g))
                    );
                  case 97:
                    return (b.t7 = b.sent), (b.t8 = b.t5.create.call(b.t5, b.t6, b.t7)), (b.next = 101), b.t4.awrap.call(b.t4, b.t8);
                  case 101:
                    return (d = b.sent), (b.t9 = regeneratorRuntime), (b.t10 = d), (b.next = 106), regeneratorRuntime.awrap(n.Action.createURI(t, 'http://www.pdftron.com'));
                  case 106:
                    return (b.t11 = b.sent), (b.t12 = b.t10.setAction.call(b.t10, b.t11)), (b.next = 110), b.t9.awrap.call(b.t9, b.t12);
                  case 110:
                    return (b.next = 112), regeneratorRuntime.awrap(f.annotPushBack(d));
                  case 112:
                    ++l, (b.next = 86);
                    break;
                  case 115:
                    ...
                    break;
                  case 118:
                    return (b.next = 120), regeneratorRuntime.awrap(t.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 120:
                    return (m = b.sent), saveBufferAsPDFDoc(m, 'credit card numbers_linked.pdf'), b.abrupt('break', 133);
                  case 123:
                    b.next = 131;
                    break;
                  case 125:
                    if (u.code !== n.TextSearch.ResultCode.e_page) {
                      b.next = 129;
                      break;
                    }
                    console.log('page end'), (b.next = 131);
                    break;
                  case 129:
                    if (u.code !== n.TextSearch.ResultCode.e_done) {
                      b.next = 131;
                      break;
                    }
                    return b.abrupt('break', 133);
                  case 131:
                    b.next = 15;
                    break;
                  case 133:
                    ...
                    break;
                  case 135:
                    (b.prev = 135), (b.t13 = b.catch(2)), console.log(b.t13);
                  case 138:
                  case 'end':
                    return b.stop();
                }
