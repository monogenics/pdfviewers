    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || R(t, D, E(1, {})), (t[D][n] = !0)), X(t, n, r)) : R(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      window.addEventListener('viewerLoaded', function() {
        r.initialize()
          .then(function() {
            return (
              (t = function(t) {
                var n, e, o, i, u, c, a, f, s, l, p, h, v, y, g;
                return regeneratorRuntime.async(function(d) {
                  for (;;)
                    switch ((d.prev = d.next)) {
                      case 0:
                        return (n = '../../samples/full-apis/TestFiles/grayscale.tif'), (d.next = 3), regeneratorRuntime.awrap(r.startDeallocateStack());
                      case 3:
                        return console.log('Traversing all annotations in the document...'), (d.next = 6), regeneratorRuntime.awrap(r.ElementWriter.create());
                      case 6:
                        return (e = d.sent), (d.next = 9), regeneratorRuntime.awrap(r.ElementBuilder.create());
                      case 9:
                        return (o = d.sent), (d.next = 12), regeneratorRuntime.awrap(r.Image.createFromURL(t, n));
                      case 12:
                        return (i = d.sent), (d.next = 15), regeneratorRuntime.awrap(t.getPageIterator(1));
                      case 15:
                        (u = d.sent), (c = 0);
                      case 18:
                        return (d.next = 20), regeneratorRuntime.awrap(u.hasNext());
                      case 20:
                        if (!d.sent) {
                          d.next = 81;
                          break;
                        }
                        return (d.next = 23), regeneratorRuntime.awrap(u.current());
                      case 23:
                        return (a = d.sent), (d.next = 26), regeneratorRuntime.awrap(a.getNumAnnots());
                      case 26:
                        (f = d.sent), (s = 0);
                      case 28:
                        if (!(s < f)) {
                        ...
                        return (d.next = 31), regeneratorRuntime.awrap(a.getAnnot(s));
                      case 31:
                        return (l = d.sent), (d.next = 34), regeneratorRuntime.awrap(l.isValid());
                      case 34:
                        if (d.sent) {
                          d.next = 36;
                          break;
                        }
                        return d.abrupt('continue', 74);
                      case 36:
                        return (d.next = 38), regeneratorRuntime.awrap(l.getType());
                      case 38:
                        (p = d.sent), (d.t0 = p), (d.next = d.t0 === r.Annot.Type.e_Stamp ? 42 : 73);
                        break;
                      case 42:
                        return e.begin(t), (d.next = 45), regeneratorRuntime.awrap(i.getImageWidth());
                      case 45:
                        return (h = d.sent), (d.next = 48), regeneratorRuntime.awrap(i.getImageHeight());
                      case 48:
                        return (v = d.sent), (d.next = 51), regeneratorRuntime.awrap(o.createImageScaled(i, 0, 0, h, v));
                      case 51:
                        return (y = d.sent), e.writePlacedElement(y), (d.next = 55), regeneratorRuntime.awrap(e.end());
                      case 55:
                        return (g = d.sent).putRect('BBox', 0, 0, h, v), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), (d.next = 61), regeneratorRuntime.awrap(o.createFormFromStream(g));
                      case 61:
                        return (y = d.sent), e.writePlacedElement(y), (d.next = 65), regeneratorRuntime.awrap(e.end());
                      case 65:
                        return (g = d.sent).putRect('BBox', 0, 0, h, v), g.putName('Subtype', 'Form'), g.putName('Type', 'XObject'), (d.next = 71), regeneratorRuntime.awrap(l.setAppearance(g));
                      case 71:
                        return (c += 1), d.abrupt('break', 74);
                      case 73:
                        return d.abrupt('break', 74);
                      case 74:
                        ++s, (d.next = 28);
                        break;
                      case 77:
                        return (d.next = 79), regeneratorRuntime.awrap(u.next());
                      case 79:
                        d.next = 18;
                        break;
                      case 81:
                        return console.log('number of annotation modifications: ' + c), (d.next = 84), regeneratorRuntime.awrap(r.endDeallocateStack());
                      case 84:
                      case 'end':
                        return d.stop();
                    }
                      ...
                      switch ((o.prev = o.next)) {
                        case 0:
                          return (
                            ...
                            (o.next = 8),
                            regeneratorRuntime.awrap(r.PDFDoc.createFromURL(e))
                          );
                        case 8:
                          return (n = o.sent).initSecurityHandler(), n.lock(), console.log('loaded document from url: ' + e), (o.next = 14), regeneratorRuntime.awrap(t(n));
                        case 14:
                          return n.flattenAnnotations(), console.log('flattened document from url: ' + e), o.abrupt('return', n);
                        case 19:
                          (o.prev = 19), (o.t0 = o.catch(1)), console.log(o.t0.stack);
                        case 22:
                          return (o.prev = 22), n && n.unlock(), o.finish(22);
                        case 25:
                        case 'end':
                          return o.stop();
                      }
            ...
            return regeneratorRuntime.async(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    readerControl.loadDocument(t), console.log('finished script');
                  case 2:
                  case 'end':
                    return n.stop();
                }
