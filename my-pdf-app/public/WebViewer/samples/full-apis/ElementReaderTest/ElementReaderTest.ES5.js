            ...
            return regeneratorRuntime.async(function(c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    return (c.next = 2), regeneratorRuntime.awrap(r.next());
                  case 2:
                    e = c.sent;
                  case 3:
                    if (null === e) {
                    ...
                    return (c.next = 6), regeneratorRuntime.awrap(e.getType());
                  case 6:
                    (o = c.sent), (c.t0 = o), (c.next = c.t0 === n.Element.Type.e_path ? 10 : c.t0 === n.Element.Type.e_text ? 16 : c.t0 === n.Element.Type.e_form ? 21 : 26);
                    break;
                  case 10:
                    return (c.next = 12), regeneratorRuntime.awrap(e.getPathData());
                  case 12:
                    return (i = c.sent), i.operators, i.points, c.abrupt('break', 26);
                  case 16:
                    return (c.next = 18), regeneratorRuntime.awrap(e.getTextString());
                  case 18:
                    return (u = c.sent), console.log(u), c.abrupt('break', 26);
                  case 21:
                    return r.formBegin(), (c.next = 24), regeneratorRuntime.awrap(t(r));
                  case 24:
                    return r.end(), c.abrupt('break', 26);
                  case 26:
                    return (c.next = 28), regeneratorRuntime.awrap(r.next());
                  case 28:
                    (e = c.sent), (c.next = 3);
                    break;
                  case 31:
              ...
              switch ((c.prev = c.next)) {
                case 0:
                  return (
                    ...
                    '../TestFiles/',
                    (c.next = 7),
                    regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf'))
                  );
                case 7:
                  return (e = c.sent).initSecurityHandler(), e.lock(), (c.next = 12), regeneratorRuntime.awrap(e.getPageCount());
                case 12:
                  return c.sent, (c.next = 15), regeneratorRuntime.awrap(n.ElementReader.create());
                case 15:
                  return (o = c.sent), (c.next = 18), regeneratorRuntime.awrap(e.getPageIterator(1));
                case 18:
                  i = c.sent;
                case 20:
                  return (c.next = 22), regeneratorRuntime.awrap(i.hasNext());
                case 22:
                  if (!c.sent) {
                    c.next = 33;
                    break;
                  }
                  return (c.next = 25), regeneratorRuntime.awrap(i.current());
                case 25:
                  return (u = c.sent), o.beginOnPage(u), (c.next = 29), regeneratorRuntime.awrap(r(o));
                case 29:
                  o.end();
                case 30:
                  i.next(), (c.next = 20);
                  break;
                case 33:
                  return console.log('Done.'), c.abrupt('return', t);
                case 35:
                case 'end':
                  return c.stop();
              }
