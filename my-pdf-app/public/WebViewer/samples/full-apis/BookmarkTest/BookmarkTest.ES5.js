!(function(t) {
      ...
      a = function t(n, r, a) {
        ...
        for (f in (v && (a = r), a))
          (l = ((s = !h && d && void 0 !== d[f]) ? d : a)[f]),
            (p = y && s ? c(l, e) : g && 'function' == typeof l ? c(Function.call, l) : l),
            d && u(d, f, l, n & t.U),
            m[f] != l && i(m, f, p),
            g && x[f] != l && (x[f] = l);
      };
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var g, y, d = i(n), m = o(d), x = e(c, v, 3), b = u(m.length), w = 0, S = r ? h(n, b) : a ? h(n, 0) : void 0; b > w; w++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        kt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(c.length), o = Ot(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        jt = function() {
        ...
        Nt = function() {
          return vt.apply(It ? pt.call(Ft(this)) : Ft(this), arguments);
        },
        Tt = {
          ...
          x
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (S(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return bt in r ? At(v, r) : kt.call(v, r);
                  (i = r), (p = Rt(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
      ...
      if (!h || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var g = /./[p],
          y = r(u, p, ''[t], function(t, n, r, e, o) {
            return n.exec === a ? (h && !o ? { done: !0, value: g.call(n, r, e) } : { done: !0, value: t.call(r, n, e) }) : { done: !1 };
          }),
          d = y[0],
          m = y[1];
    ...
    t.exports = function(t, n, r, g, y, d) {
      ...
      if (
        ...
        O ||
          ...
          (w.constructor = x)),
          (F || P) && (_('delete'), _('has'), y && _('get')),
          (P || R) && _(b),
          d && w.clear && delete w.clear;
      } else (x = g.getConstructor(n, t, y, b)), u(x.prototype, r), (c.NEED = !0);
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, g, y, d) {
      ...
      var m,
        ...
        E = !1,
        R = t.prototype,
        F = R[l] || R['@@iterator'] || (g && R[g]),
        O = F || w(g),
        P = g ? (_ ? w('entries') : O) : void 0,
        A = ('Array' == n && R.entries) || F;
      if (
        (A && (b = s(A.call(new t()))) !== Object.prototype && b.next && (f(b, S, !0), e || 'function' == typeof b[l] || u(b, l, h)),
        _ &&
          F &&
          'values' !== F.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? O : w('values'), keys: y ? O : w('keys'), entries: P }), d)) for (x in m) x in R || i(R, x, m[x]);
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[k]._b, a = u + t[I], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = c(t), f = arguments.length, s = 1, l = i.f, p = u.f; f > s; )
              for (var h, v = a(arguments[s++]), g = l ? o(v).concat(l(v)) : o(v), y = g.length, d = 0; y > d; ) (h = g[d++]), (e && !p.call(v, h)) || (r[h] = v[h]);
            return r;
          }
        : f;
  },
    ...
    var e,
      ...
      k = !!(function() {
        try {
          ...
          return (P || 'function' == typeof PromiseRejectionEvent) && t.then(A) instanceof n && 0 !== F.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
      ...
      N = function(t) {
        d.call(a, function() {
          ...
          if (
            (i &&
              ((n = b(function() {
                P ? E.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = P || T(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
    ...
    t.exports = {
      ...
      def: function(t, n, r) {
        var e,
          o,
          i = y(t, n);
        return i ? (i.v = r) : ((t._l = i = { i: (o = h(n, !0)), k: n, v: r, p: (e = t._l), n: void 0, r: !1 }), t._f || (t._f = i), e && (e.n = i), t[g]++, 'F' !== o && (t._i[o] = i)), t;
      },
      getEntry: y,
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          x(r),
          i(W, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = R(r, { enumerable: E(0, !1) }))) : (i(t, D) || j(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : j(t, n, r)
        );
      },
      X = function(t, n) {
        x(t);
  ...
  function(t, n, r) {
    ...
    if (!h(' 0o1') || !h('0b1') || h('+0x1')) {
      ...
      (h.prototype = g), (g.constructor = h), r(11)(e, 'Number', h);
    }
  },
  function(t, n, r) {
    'use strict';
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            m = s(p);
          if ((y && (g = e(g, v > 2 ? arguments[2] : void 0, 2)), null == m || (h == Array && c(m)))) for (r = new h((n = a(p.length))); n > d; d++) f(r, d, y ? g(p[d], d) : p[d]);
          else for (l = m.call(p), r = new h(); !(o = l.next()).done; d++) f(r, d, y ? u(l, g, [o.value, d], !0) : o.value);
          return (r.length = d), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, w = '', S = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), R = f(s(u(x.index), p.length), 0), F = [], O = 1; O < x.length; O++) F.push(void 0 === (b = x[O]) ? b : String(b));
            var P = x.groups;
            if (h) {
              var A = [E].concat(F, R, p);
              void 0 !== P && A.push(P);
              var M = String(n.apply(void 0, A));
            } else M = g(E, p, R, F, P, n);
            R >= S && ((w += p.slice(S, R) + M), (S = R + E.length));
          }
          return w + p.slice(S);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, w = 0, S = []; w < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(w));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : w)), p.length)) === b) w = u(p, w, y);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        x = u[d],
        b = x && x.prototype;
      if (b && (b[s] || c(b, s, p), b[l] || c(b, l, d), (a[d] = p), m)) for (y in e) b[y] || i(b, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
            ...
            (i._invoke = (function(t, n, r) {
              ...
              return function(o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var a = s(t, n, r);
                  if ('normal' === a.type) {
                    if (((e = r.done ? v : p), a.arg === g)) continue;
        ...
        function R(t, n) {
          ...
          if (e === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = r), R(t, n), 'throw' === n.method)) return g;
        ...
        return (
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), g;
            },
          }),
          t
        );
    ...
    !(function(t) {
      t.runBookmarkTest = function() {
            ...
            return regeneratorRuntime.async(function(o) {
              for (;;)
                switch ((o.prev = o.next)) {
                  case 0:
                    return (o.next = 2), regeneratorRuntime.awrap(t.getIndent());
                  case 2:
                    for (o.t0 = o.sent, r = o.t0 - 1, e = 0; e < r; ++e) n += '  ';
              ...
              for (;;)
                switch ((s.prev = s.next)) {
                  case 0:
                    ...
                    return (o = ''), (i = ''), (u = ''), (s.next = 6), regeneratorRuntime.awrap(r(e, o));
                  case 6:
                    return (o = s.sent), (s.next = 9), regeneratorRuntime.awrap(e.getTitle());
                  case 9:
                    return (u = s.sent), (s.t0 = o), (s.next = 13), regeneratorRuntime.awrap(e.isOpen());
                  case 13:
                    if (((s.t1 = s.sent), !(s.t0 + s.t1))) {
                      s.next = 18;
                      break;
                    }
                    (s.t2 = '- '), (s.next = 19);
                  ...
                  case 18:
                    s.t2 = '+ ';
                  case 19:
                    return (s.t3 = s.t2), (s.t4 = u), (s.t5 = s.t3 + s.t4), (i = s.t5 + ' ACTION -> '), (s.next = 25), regeneratorRuntime.awrap(e.getAction());
                  case 25:
                    return (c = s.sent), (s.next = 28), regeneratorRuntime.awrap(c.isValid());
                  case 28:
                    if (!s.sent) {
                      s.next = 54;
                      break;
                    }
                    return (s.next = 31), regeneratorRuntime.awrap(c.getType());
                  case 31:
                    if (s.sent !== n.Action.Type.e_GoTo) {
                      s.next = 51;
                      break;
                    }
                    return (s.next = 35), regeneratorRuntime.awrap(c.getDest());
                  case 35:
                    return (a = s.sent), (s.next = 38), regeneratorRuntime.awrap(a.isValid());
                  case 38:
                    if (!s.sent) {
                      s.next = 49;
                      break;
                    }
                    return (s.next = 41), regeneratorRuntime.awrap(a.getPage());
                  case 41:
                    return (f = s.sent), (s.t6 = console), (s.t7 = i + 'GoTo Page # '), (s.next = 46), regeneratorRuntime.awrap(f.getIndex());
                  case 46:
                    (s.t8 = s.sent), (s.t9 = s.t7 + s.t8), s.t6.log.call(s.t6, s.t9);
                  case 49:
                    s.next = 52;
                    break;
                  case 51:
                    console.log(i + 'Not a "GoTo" action');
                  case 52:
                    s.next = 55;
                    break;
                  case 54:
                    console.log(i + 'NULL');
                  case 55:
                    return (s.next = 57), regeneratorRuntime.awrap(e.hasChildren());
                  case 57:
                    if (!s.sent) {
                      s.next = 66;
                      break;
                    }
                    return (s.t10 = regeneratorRuntime), (s.t11 = t), (s.next = 62), regeneratorRuntime.awrap(e.getFirstChild());
                  case 62:
                    return (s.t12 = s.sent), (s.t13 = (0, s.t11)(s.t12)), (s.next = 66), s.t10.awrap.call(s.t10, s.t13);
                  case 66:
                    return (s.next = 68), regeneratorRuntime.awrap(e.getNext());
                  case 68:
                    (e = s.sent), (s.next = 0);
                    break;
                  case 71:
        ...
        n.runWithCleanup(function() {
          var t, r, o, i, u, c, a, f, s, l, p, h, v, g, y, d, m, x, b, w, S, _, E, R, F, O, P, A, M, k, j, I, N, T;
          return regeneratorRuntime.async(function(L) {
            for (;;)
              switch ((L.prev = L.next)) {
                case 0:
                  return (t = 0), '../TestFiles/', (L.next = 4), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/numbered.pdf'));
                case 4:
                  return (r = L.sent).initSecurityHandler(), r.lock(), (L.next = 9), regeneratorRuntime.awrap(n.Bookmark.create(r, 'Red'));
                case 9:
                  return (o = L.sent), (L.next = 12), regeneratorRuntime.awrap(n.Bookmark.create(r, 'Green'));
                case 12:
                  return (i = L.sent), (L.next = 15), regeneratorRuntime.awrap(n.Bookmark.create(r, 'Blue'));
                case 15:
                  return (
                    (u = L.sent),
                    r.addRootBookmark(o),
                    ...
                    u.addNewNext('bar'),
                    (L.next = 23),
                    regeneratorRuntime.awrap(r.getPageIterator(1))
                  );
                case 23:
                  return (c = L.sent), (L.next = 26), regeneratorRuntime.awrap(c.current());
                case 26:
                  return (a = L.sent), (L.next = 29), regeneratorRuntime.awrap(r.getPage(1));
                case 29:
                  return L.sent, (L.next = 32), regeneratorRuntime.awrap(n.Destination.createFit(a));
                case 32:
                  return (f = L.sent), (L.t0 = o), (L.next = 36), regeneratorRuntime.awrap(n.Action.createGoto(f));
                case 36:
                  return (L.t1 = L.sent), L.t0.setAction.call(L.t0, L.t1), (L.next = 40), regeneratorRuntime.awrap(r.getPage(10));
                case 40:
                  return (s = L.sent), (L.next = 43), regeneratorRuntime.awrap(n.Destination.createFit(s));
                case 43:
                  return (l = L.sent), (L.t2 = i), (L.next = 47), regeneratorRuntime.awrap(n.Action.createGoto(l));
                case 47:
                  return (L.t3 = L.sent), L.t2.setAction.call(L.t2, L.t3), (p = 'blue1'), (L.next = 52), regeneratorRuntime.awrap(r.getPage(19));
                case 52:
                  return (h = L.sent), (L.next = 55), regeneratorRuntime.awrap(n.Destination.createFit(h));
                case 55:
                  return (v = L.sent), (L.next = 58), regeneratorRuntime.awrap(n.Action.createGotoWithKey(p, v));
                case 58:
                  return (g = L.sent), u.setAction(g), (L.next = 62), regeneratorRuntime.awrap(o.addNewChild('Red - Page 1'));
                case 62:
                  return (
                    (y = L.sent), (L.t4 = y), (L.t5 = regeneratorRuntime), (L.t6 = n.Action), (L.t7 = regeneratorRuntime), (L.t8 = n.Destination), (L.next = 70), regeneratorRuntime.awrap(r.getPage(1))
                  );
                case 70:
                  return (L.t9 = L.sent), (L.t10 = L.t8.createFit.call(L.t8, L.t9)), (L.next = 74), L.t7.awrap.call(L.t7, L.t10);
                case 74:
                  return (L.t11 = L.sent), (L.t12 = L.t6.createGoto.call(L.t6, L.t11)), (L.next = 78), L.t5.awrap.call(L.t5, L.t12);
                case 78:
                  return (L.t13 = L.sent), L.t4.setAction.call(L.t4, L.t13), (L.next = 82), regeneratorRuntime.awrap(o.addNewChild('Red - Page 2'));
                case 82:
                  return (
                    (d = L.sent),
                    (L.t14 = d),
                    (L.t15 = regeneratorRuntime),
                    (L.t16 = n.Action),
                    (L.t17 = regeneratorRuntime),
                    (L.t18 = n.Destination),
                    (L.next = 90),
                    regeneratorRuntime.awrap(r.getPage(2))
                  );
                case 90:
                  return (L.t19 = L.sent), (L.t20 = L.t18.createFit.call(L.t18, L.t19)), (L.next = 94), L.t17.awrap.call(L.t17, L.t20);
                case 94:
                  return (L.t21 = L.sent), (L.t22 = L.t16.createGoto.call(L.t16, L.t21)), (L.next = 98), L.t15.awrap.call(L.t15, L.t22);
                case 98:
                  return (L.t23 = L.sent), L.t14.setAction.call(L.t14, L.t23), (L.next = 102), regeneratorRuntime.awrap(o.addNewChild('Red - Page 3'));
                case 102:
                  return (
                    (m = L.sent),
                    (L.t24 = m),
                    (L.t25 = regeneratorRuntime),
                    (L.t26 = n.Action),
                    (L.t27 = regeneratorRuntime),
                    (L.t28 = n.Destination),
                    (L.next = 110),
                    regeneratorRuntime.awrap(r.getPage(3))
                  );
                case 110:
                  return (L.t29 = L.sent), (L.t30 = L.t28.createFit.call(L.t28, L.t29)), (L.next = 114), L.t27.awrap.call(L.t27, L.t30);
                case 114:
                  return (L.t31 = L.sent), (L.t32 = L.t26.createGoto.call(L.t26, L.t31)), (L.next = 118), L.t25.awrap.call(L.t25, L.t32);
                case 118:
                  return (L.t33 = L.sent), L.t24.setAction.call(L.t24, L.t33), (L.next = 122), regeneratorRuntime.awrap(m.addNewChild('Red - Page 4'));
                case 122:
                  return (
                    (x = L.sent),
                    (L.t34 = x),
                    (L.t35 = regeneratorRuntime),
                    (L.t36 = n.Action),
                    (L.t37 = regeneratorRuntime),
                    (L.t38 = n.Destination),
                    (L.next = 130),
                    regeneratorRuntime.awrap(r.getPage(4))
                  );
                case 130:
                  return (L.t39 = L.sent), (L.t40 = L.t38.createFit.call(L.t38, L.t39)), (L.next = 134), L.t37.awrap.call(L.t37, L.t40);
                case 134:
                  return (L.t41 = L.sent), (L.t42 = L.t36.createGoto.call(L.t36, L.t41)), (L.next = 138), L.t35.awrap.call(L.t35, L.t42);
                case 138:
                  return (L.t43 = L.sent), L.t34.setAction.call(L.t34, L.t43), (L.next = 142), regeneratorRuntime.awrap(m.addNewChild('Red - Page 5'));
                case 142:
                  return (
                    (b = L.sent),
                    (L.t44 = b),
                    (L.t45 = regeneratorRuntime),
                    (L.t46 = n.Action),
                    (L.t47 = regeneratorRuntime),
                    (L.t48 = n.Destination),
                    (L.next = 150),
                    regeneratorRuntime.awrap(r.getPage(5))
                  );
                case 150:
                  return (L.t49 = L.sent), (L.t50 = L.t48.createFit.call(L.t48, L.t49)), (L.next = 154), L.t47.awrap.call(L.t47, L.t50);
                case 154:
                  return (L.t51 = L.sent), (L.t52 = L.t46.createGoto.call(L.t46, L.t51)), (L.next = 158), L.t45.awrap.call(L.t45, L.t52);
                case 158:
                  return (L.t53 = L.sent), L.t44.setAction.call(L.t44, L.t53), (L.next = 162), regeneratorRuntime.awrap(m.addNewChild('Red - Page 6'));
                case 162:
                  return (
                    (w = L.sent),
                    (L.t54 = w),
                    (L.t55 = regeneratorRuntime),
                    (L.t56 = n.Action),
                    (L.t57 = regeneratorRuntime),
                    (L.t58 = n.Destination),
                    (L.next = 170),
                    regeneratorRuntime.awrap(r.getPage(6))
                  );
                case 170:
                  return (L.t59 = L.sent), (L.t60 = L.t58.createFit.call(L.t58, L.t59)), (L.next = 174), L.t57.awrap.call(L.t57, L.t60);
                case 174:
                  return (L.t61 = L.sent), (L.t62 = L.t56.createGoto.call(L.t56, L.t61)), (L.next = 178), L.t55.awrap.call(L.t55, L.t62);
                case 178:
                  return (L.t63 = L.sent), L.t54.setAction.call(L.t54, L.t63), (L.next = 182), regeneratorRuntime.awrap(r.getFirstBookmark());
                case 182:
                  return (S = L.sent), (L.next = 185), regeneratorRuntime.awrap(S.find('foo'));
                case 185:
                  return (_ = L.sent), (L.next = 188), regeneratorRuntime.awrap(_.isValid());
                case 188:
                  if (!L.sent) {
                    L.next = 192;
                    break;
                ...
                case 193:
                  return (L.next = 195), regeneratorRuntime.awrap(S.find('bar'));
                case 195:
                  return (E = L.sent), (L.next = 198), regeneratorRuntime.awrap(E.isValid());
                case 198:
                  if (!L.sent) {
                    L.next = 202;
                    break;
                ...
                case 203:
                  return o.setColor(1, 0, 0), i.setColor(0, 1, 0), i.setFlags(2), u.setColor(0, 0, 1), u.setFlags(3), (L.next = 210), regeneratorRuntime.awrap(r.saveMemoryBuffer(0));
                case 210:
                  return (R = L.sent), saveBufferAsPDFDoc(R, 'bookmark.pdf'), console.log('Done. Result saved in bookmark.pdf'), (L.next = 215), regeneratorRuntime.awrap(n.PDFDoc.createFromBuffer(R));
                case 215:
                  return (F = L.sent).initSecurityHandler(), F.lock(), (L.next = 220), regeneratorRuntime.awrap(F.getFirstBookmark());
                case 220:
                  return (O = L.sent), (L.next = 223), regeneratorRuntime.awrap(e(O));
                case 223:
                  return console.log('Done.'), (r = F).initSecurityHandler(), (L.next = 228), regeneratorRuntime.awrap(r.createIndirectDict());
                case 228:
                  return (P = L.sent).putName('Type', 'Filespec'), P.putString('F', 'bookmark.pdf'), (L.next = 233), regeneratorRuntime.awrap(n.FileSpec.createFromObj(P));
                case 233:
                  return (A = L.sent), (L.next = 236), regeneratorRuntime.awrap(n.Action.createGotoRemoteSetNewWindow(A, 5, !0));
                case 236:
                  return (M = L.sent), (L.next = 239), regeneratorRuntime.awrap(n.Bookmark.create(r, 'REMOTE BOOKMARK 1'));
                case 239:
                  return (k = L.sent).setAction(M), r.addRootBookmark(k), (L.next = 244), regeneratorRuntime.awrap(n.Bookmark.create(r, 'REMOTE BOOKMARK 2'));
                case 244:
                  return (j = L.sent), r.addRootBookmark(j), (L.t64 = regeneratorRuntime), (L.next = 249), regeneratorRuntime.awrap(j.getSDFObj());
                case 249:
                  return (L.t65 = L.sent.putDict('A')), (L.next = 252), L.t64.awrap.call(L.t64, L.t65);
                case 252:
                  return (I = L.sent).putName('S', 'GoToR'), I.putBool('NewWindow', !0), I.put('F', P), (L.next = 258), regeneratorRuntime.awrap(I.putArray('D'));
                case 258:
                  return (N = L.sent).pushBackNumber(9), N.pushBackName('Fit'), (L.next = 263), regeneratorRuntime.awrap(r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused));
                case 263:
                  return (T = L.sent), saveBufferAsPDFDoc(T, 'bookmark_remote.pdf'), console.log('Done. Result saved in bookmark_remote.pdf'), L.abrupt('return', t);
                case 267:
                case 'end':
                  return L.stop();
              }
