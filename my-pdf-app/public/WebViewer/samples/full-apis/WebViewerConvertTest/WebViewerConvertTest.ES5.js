    ...
    !(function(t) {
      t.runWebViewerConvertTest = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, f, a, s, l, h, p;
          return regeneratorRuntime.async(
            function(v) {
              for (;;)
                switch ((v.prev = v.next)) {
                  case 0:
                    return console.log('Beginning Test'), (t = 0), '../TestFiles/', (v.prev = 3), (v.next = 6), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/tiger.pdf'));
                  case 6:
                    return (r = v.sent).initSecurityHandler(), r.lock(), console.log('PDFNet and PDF document initialized and locked'), (v.next = 12), regeneratorRuntime.awrap(r.convertToXod());
                  case 12:
                    return (e = v.sent), saveBufferAsXOD(e, 'from_pdf.xod'), (v.next = 16), regeneratorRuntime.awrap(r.convertToXodStream());
                  case 16:
                    return (o = v.sent), (v.next = 19), regeneratorRuntime.awrap(n.FilterReader.create(o));
                  case 19:
                    (i = v.sent), (u = []), (f = c = 1024);
                  case 23:
                    if (c !== f) {
                    ...
                    return (v.next = 26), regeneratorRuntime.awrap(i.read(c));
                  case 26:
                    (a = v.sent), (f = a.length), u.push(a), (v.next = 23);
                    break;
                  case 31:
                    for (s = new Uint8Array(u.length * c + f), l = 0; l < u.length; l++) (h = l * c), (p = u[l]), s.set(p, h);
                    saveBufferAsXOD(s, 'from_pdf_streamed.xod'), console.log('done.'), (v.next = 41);
                    break;
                  case 37:
                    (v.prev = 37), (v.t0 = v.catch(3)), console.log(v.t0.stack), (t = 1);
                  case 41:
