                ...
                switch ((h.prev = h.next)) {
                  case 0:
                    return (
                      ...
                      (h.next = 6),
                      regeneratorRuntime.awrap(r(t + 'form1_annots.xfdf'))
                    );
                  case 6:
                    return (e = h.sent), (h.next = 9), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'form1.pdf'));
                  case 9:
                    return (
                      (o = h.sent).initSecurityHandler(),
                      console.log('Update annotations from fdf'),
                      o.fdfUpdate(e),
                      (h.next = 15),
                      regeneratorRuntime.awrap(o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 15:
                    (i = h.sent), saveBufferAsPDFDoc(i, 'form1_with_annots.pdf'), console.log('Done sample'), (h.next = 23);
                    break;
                  case 20:
                    (h.prev = 20), (h.t0 = h.catch(2)), console.log(h.t0);
                  case 23:
                    return (h.prev = 23), console.log('Extract annotations from PDF.'), (h.next = 27), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(''.concat(t, 'form1.pdf')));
                  case 27:
                    return (u = h.sent).initSecurityHandler(), (h.next = 31), regeneratorRuntime.awrap(u.fdfExtract(n.PDFDoc.ExtractFlag.e_both));
                  case 31:
                    return (c = h.sent), (h.next = 34), regeneratorRuntime.awrap(c.saveAsXFDFAsString());
                  case 34:
                    (f = h.sent), console.log('XFDF extracted from form1.pdf'), console.log(f), console.log('Done sample'), (h.next = 43);
                    break;
                  case 40:
                    (h.prev = 40), (h.t1 = h.catch(23)), console.log(h.t1);
                  case 43:
                    return (h.prev = 43), console.log('Extract existing fields from PDF.'), (h.next = 47), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(''.concat(t, 'form1.pdf')));
                  case 47:
                    return (a = h.sent).initSecurityHandler(), (h.next = 51), regeneratorRuntime.awrap(a.getFieldIteratorBegin());
                  case 51:
                    s = h.sent;
                  case 52:
                    return (h.next = 54), regeneratorRuntime.awrap(s.hasNext());
                  case 54:
                    if (!h.sent) {
                      h.next = 66;
                      break;
                    }
                    return (h.next = 57), regeneratorRuntime.awrap(s.current());
                  case 57:
                    return (l = h.sent), (h.t2 = console), (h.next = 61), regeneratorRuntime.awrap(l.getName());
                  case 61:
                    (h.t3 = h.sent), h.t2.log.call(h.t2, h.t3);
                  case 63:
                    s.next(), (h.next = 52);
                    break;
                  case 66:
                    console.log('Done sample'), (h.next = 72);
                    break;
                  case 69:
                    (h.prev = 69), (h.t4 = h.catch(43)), console.log(h.t4);
                  case 72:
                  case 'end':
                    return h.stop();
                }
