  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = function() {
          return vt.apply(Rt ? ht.call(Ot(this)) : Ot(this), arguments);
        },
        Lt = {
      ...
      v(Gt, Ct),
        p(Gt, yt, Ct.values),
        v(Gt, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
    ...
    !(function(t) {
      t.runSDFTest = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, f, a, s, l, h, p, v, y;
          return regeneratorRuntime.async(
            function(g) {
              for (;;)
                switch ((g.prev = g.next)) {
                  case 0:
                    return console.log('Beginning SDF Test.'), (t = '../TestFiles/'), (g.prev = 2), (g.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'fish.pdf'));
                  case 5:
                    return (r = g.sent), (g.next = 8), regeneratorRuntime.awrap(r.getSDFDoc());
                  case 8:
                    return (
                      (e = g.sent).initSecurityHandler(),
                      e.lock(),
                  ...
                  case 14:
                    return (o = g.sent), (g.next = 17), regeneratorRuntime.awrap(o.find('Info'));
                  case 17:
                    return (i = g.sent), (g.next = 20), regeneratorRuntime.awrap(i.hasNext());
                  case 20:
                    if (!g.sent) {
                      g.next = 43;
                      break;
                    }
                    return (g.next = 23), regeneratorRuntime.awrap(i.value());
                  case 23:
                    return (u = g.sent).putString('Producer', 'PDFTron PDFNet'), (g.next = 27), regeneratorRuntime.awrap(u.find('Author'));
                  case 27:
                    return (i = g.sent), (g.next = 30), regeneratorRuntime.awrap(i.hasNext());
                  case 30:
                    if (!g.sent) {
                      g.next = 40;
                      break;
                    }
                    return (g.next = 33), regeneratorRuntime.awrap(i.value());
                  case 33:
                    return (c = g.sent), (g.next = 36), regeneratorRuntime.awrap(c.getAsPDFText());
                  case 36:
                    (f = g.sent), u.putText('Author', f + ' - Modified'), (g.next = 41);
                    break;
                  case 40:
                    u.putString('Author', 'Me, myself, and I');
                  case 41:
                    g.next = 48;
                    break;
                  case 43:
                    return (g.next = 45), regeneratorRuntime.awrap(o.putDict('Info'));
                  case 45:
                    (u = g.sent).putString('Producer', 'PDFTron PDFNet'), u.putString('Title', 'My document');
                  case 48:
                    return (g.next = 50), regeneratorRuntime.awrap(u.putDict('My Direct Dict'));
                  case 50:
                    return (a = g.sent).putNumber('My Number', 100), a.putArray('My Array'), (g.next = 55), regeneratorRuntime.awrap(e.createIndirectArray());
                  case 55:
                    return (s = g.sent), u.put('My Indirect Array', s), (g.next = 59), regeneratorRuntime.awrap(o.get('Root'));
                  case 59:
                    return (l = g.sent), (g.t0 = s), (g.next = 63), regeneratorRuntime.awrap(l.value());
                  case 63:
                    return (g.t1 = g.sent), g.t0.pushBack.call(g.t0, g.t1), (g.next = 67), regeneratorRuntime.awrap(n.Filter.createURLFilter(t + 'my_stream.txt'));
                  case 67:
                    return (h = g.sent), (g.next = 70), regeneratorRuntime.awrap(n.FilterReader.create(h));
                  case 70:
                    return (p = g.sent), (g.next = 73), regeneratorRuntime.awrap(e.createIndirectStreamFromFilter(p));
                  case 73:
                    return (v = g.sent), s.pushBack(v), (g.next = 77), regeneratorRuntime.awrap(e.saveMemory(0, '%PDF-1.4'));
                  case 77:
                    (y = g.sent), saveBufferAsPDFDoc(y, 'sdftest_out.pdf'), console.log('Done.'), (g.next = 85);
                    break;
                  case 82:
                    (g.prev = 82), (g.t2 = g.catch(2)), console.log(g.t2);
                  case 85:
                  case 'end':
                    return g.stop();
                }
