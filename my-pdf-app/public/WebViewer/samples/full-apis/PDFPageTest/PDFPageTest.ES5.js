!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Nt = function() {
          return vt.apply(kt ? pt.call(Ft(this)) : Ft(this), arguments);
        },
        Dt = {
          ...
          subarray: function(t, n) {
            var r = Ft(this),
              e = r.length,
              o = m(t, e);
            return new (k(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Tt = function(t, n) {
      ...
      v(Gt, Ct),
        h(Gt, yt, Ct.values),
        v(Gt, { slice: Tt, set: Lt, constructor: function() {}, toString: ht, toLocaleString: Nt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      var u = h(+r);
      if (u + n > t[R]) throw _(b);
      for (var c = t[j]._b, a = u + t[k], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && T(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(_('Promise-chain cycle')) : (i = R(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (r = E(r, { enumerable: P(0, !1) }))) : (i(t, L) || R(t, L, P(1, {})), (t[L][n] = !0)), q(t, n, r)) : R(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(U, t) && !i(G, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, L) && this[L][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, r = k(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == L || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = k(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), q(this, t, P(1, r));
            };
    ...
    !(function(t) {
      t.runPDFPageTest = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, a, f, s, l, p, h, v, y, g, d, m, b, x, S, w, _, P, E, F, O, M;
          return regeneratorRuntime.async(
            function(A) {
              for (;;)
                switch ((A.prev = A.next)) {
                  case 0:
                    return console.log('Beginning Test'), 0, (t = '../TestFiles/'), (r = null), (A.prev = 4), (A.next = 7), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'newsletter.pdf'));
                  case 7:
                    return (e = A.sent).initSecurityHandler(), e.lock(), console.log('PDF document initialized and locked'), (A.next = 13), regeneratorRuntime.awrap(e.getPageCount());
                  case 13:
                    (o = A.sent), (i = Math.min(4, o)), (r = []), (u = 1);
                  case 17:
                    if (!(u <= i)) {
                      A.next = 32;
                      break;
                    }
                    return (A.next = 20), regeneratorRuntime.awrap(n.PDFDoc.create());
                  case 20:
                    return (
                      (c = A.sent),
                      (a = 'newsletter_split_page_' + u + '.pdf'),
                      c.insertPages(0, e, u, u, n.PDFDoc.InsertFlag.e_none),
                      (r[u - 1] = c),
                      (A.next = 26),
                      regeneratorRuntime.awrap(c.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 26:
                    (f = A.sent), saveBufferAsPDFDoc(f, a), console.log('Result saved as ' + a);
                  case 29:
                    ++u, (A.next = 17);
                    break;
                  case 32:
                    ...
                    break;
                  case 34:
                    (A.prev = 34), (A.t0 = A.catch(4)), console.log(A.t0.stack), 1;
                  case 38:
                    return (A.prev = 38), (A.next = 41), regeneratorRuntime.awrap(n.startDeallocateStack());
                  case 41:
                    return (A.next = 43), regeneratorRuntime.awrap(n.PDFDoc.create());
                  case 43:
                    (s = A.sent).initSecurityHandler(), s.lock(), console.log('Sample 2, merge several PDF documents into one:'), (l = 1);
                  case 48:
                    if (!(l <= r.length)) {
                      A.next = 57;
                      break;
                    }
                    return (p = r[l - 1]), (A.next = 52), regeneratorRuntime.awrap(p.getPageCount());
                  case 52:
                    (h = A.sent), s.insertPages(l, p, 1, h, n.PDFDoc.InsertFlag.e_none);
                  case 54:
                    ++l, (A.next = 48);
                    break;
                  case 57:
                    return (A.next = 59), regeneratorRuntime.awrap(s.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 59:
                    return (v = A.sent), saveBufferAsPDFDoc(v, 'newsletter_merged.pdf'), (A.next = 63), regeneratorRuntime.awrap(n.endDeallocateStack());
                  case 63:
                    A.next = 69;
                    break;
                  case 65:
                    (A.prev = 65), (A.t1 = A.catch(38)), console.log(A.t1.stack), 1;
                  case 69:
                    return (A.prev = 69), (A.next = 72), regeneratorRuntime.awrap(n.startDeallocateStack());
                  case 72:
                    return console.log('Sample 3, delete every second page'), (A.next = 75), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'newsletter.pdf'));
                  case 75:
                    return (y = A.sent).initSecurityHandler(), y.lock(), (A.next = 80), regeneratorRuntime.awrap(y.getPageCount());
                  case 80:
                    g = A.sent;
                  case 81:
                    if (!(g >= 1)) {
                    ...
                    return (A.next = 84), regeneratorRuntime.awrap(y.getPageIterator(g));
                  case 84:
                    (d = A.sent), y.pageRemove(d), (g -= 2), (A.next = 81);
                    break;
                  case 89:
                    return (A.next = 91), regeneratorRuntime.awrap(y.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 91:
                    return (m = A.sent), saveBufferAsPDFDoc(m, 'newsletter_page_removed.pdf'), (A.next = 95), regeneratorRuntime.awrap(n.endDeallocateStack());
                  case 95:
                    A.next = 101;
                    break;
                  case 97:
                    (A.prev = 97), (A.t2 = A.catch(69)), console.log(A.t2), 1;
                  case 101:
                    return (A.prev = 101), (A.next = 104), regeneratorRuntime.awrap(n.startDeallocateStack());
                  case 104:
                    return console.log('Sample 4, Insert a page at different locations'), (A.next = 107), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'newsletter.pdf'));
                  case 107:
                    return (b = A.sent).initSecurityHandler(), b.lock(), (A.next = 112), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'fish.pdf'));
                  case 112:
                    return (x = A.sent).initSecurityHandler(), x.lock(), (A.next = 117), regeneratorRuntime.awrap(x.getPageIterator(1));
                  case 117:
                    return (S = A.sent), (A.next = 120), regeneratorRuntime.awrap(b.getPageIterator(1));
                  case 120:
                    (w = A.sent), (_ = 1);
                  case 122:
                    return (A.next = 124), regeneratorRuntime.awrap(w.hasNext());
                  case 124:
                    if (!A.sent) {
                      A.next = 135;
                      break;
                    ...
                    return (A.t3 = b), (A.t4 = w), (A.next = 130), regeneratorRuntime.awrap(S.current());
                  case 130:
                    (A.t5 = A.sent), A.t3.pageInsert.call(A.t3, A.t4, A.t5);
                  case 132:
                    w.next(), (A.next = 122);
                    break;
                  case 135:
                    return (A.next = 137), regeneratorRuntime.awrap(b.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 137:
                    return (P = A.sent), saveBufferAsPDFDoc(P, 'newsletter_page_insert.pdf'), console.log('done'), (A.next = 142), regeneratorRuntime.awrap(n.endDeallocateStack());
                  case 142:
                    A.next = 148;
                    break;
                  case 144:
                    (A.prev = 144), (A.t6 = A.catch(101)), console.log(A.t6.stack), 1;
                  case 148:
                    return (A.prev = 148), (A.next = 151), regeneratorRuntime.awrap(n.startDeallocateStack());
                  case 151:
                    return console.log('Sample 5, replicate pages within a single document'), (A.next = 154), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'newsletter.pdf'));
                  case 154:
                    return (E = A.sent).initSecurityHandler(), (A.next = 158), regeneratorRuntime.awrap(E.getPage(1));
                  case 158:
                    return (F = A.sent), (A.next = 161), regeneratorRuntime.awrap(E.getPageIterator(7));
                  case 161:
                    return (
                      (O = A.sent),
                      E.pageInsert(O, F),
                      ...
                      E.pagePushBack(F),
                      (A.next = 169),
                      regeneratorRuntime.awrap(E.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 169:
                    return (
                      (M = A.sent),
                      saveBufferAsPDFDoc(M, 'newsletter_page_clone.pdf'),
                      console.log('done saving newsletter_page_clone.pdf'),
                      (A.next = 174),
                      regeneratorRuntime.awrap(n.endDeallocateStack())
                    );
                  case 174:
                    A.next = 180;
                    break;
                  case 176:
                    (A.prev = 176), (A.t7 = A.catch(148)), console.log(A.t7.stack), 1;
                  case 180:
                  case 'end':
                    return A.stop();
                }
