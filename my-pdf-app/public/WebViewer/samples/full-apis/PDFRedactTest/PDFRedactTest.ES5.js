!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : Rt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[R]._b, a = u + t[N], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || I(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : I(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
            ...
            function(c) {
              for (;;)
                switch ((c.prev = c.next)) {
                  case 0:
                    return '../TestFiles/', 0, (c.prev = 2), (c.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf'));
                  case 5:
                    return (
                      (t = c.sent).initSecurityHandler(),
                      t.lock(),
                      (r = []),
                      (c.t0 = r),
                      (c.t1 = regeneratorRuntime),
                      (c.t2 = n.Redactor),
                      (c.next = 14),
                      regeneratorRuntime.awrap(n.Rect.init(100, 100, 550, 600))
                    );
                  case 14:
                    return (c.t3 = c.sent), (c.t4 = c.t2.redactionCreate.call(c.t2, 1, c.t3, !1, 'Top Secret')), (c.next = 18), c.t1.awrap.call(c.t1, c.t4);
                  case 18:
                    return (
                      (c.t5 = c.sent), c.t0.push.call(c.t0, c.t5), (c.t6 = r), (c.t7 = regeneratorRuntime), (c.t8 = n.Redactor), (c.next = 25), regeneratorRuntime.awrap(n.Rect.init(30, 30, 450, 450))
                    );
                  case 25:
                    return (c.t9 = c.sent), (c.t10 = c.t8.redactionCreate.call(c.t8, 2, c.t9, !0, 'Negative Redaction')), (c.next = 29), c.t7.awrap.call(c.t7, c.t10);
                  case 29:
                    return (
                      (c.t11 = c.sent),
                      c.t6.push.call(c.t6, c.t11),
                      (c.t12 = r),
                      (c.t13 = regeneratorRuntime),
                      (c.t14 = n.Redactor),
                      (c.next = 36),
                      regeneratorRuntime.awrap(n.Rect.init(0, 0, 100, 100))
                    );
                  case 36:
                    return (c.t15 = c.sent), (c.t16 = c.t14.redactionCreate.call(c.t14, 2, c.t15, !1, 'Positive')), (c.next = 40), c.t13.awrap.call(c.t13, c.t16);
                  case 40:
                    return (
                      (c.t17 = c.sent),
                      c.t12.push.call(c.t12, c.t17),
                      (c.t18 = r),
                      (c.t19 = regeneratorRuntime),
                      (c.t20 = n.Redactor),
                      (c.next = 47),
                      regeneratorRuntime.awrap(n.Rect.init(100, 100, 200, 200))
                    );
                  case 47:
                    return (c.t21 = c.sent), (c.t22 = c.t20.redactionCreate.call(c.t20, 2, c.t21, !1, 'Positive')), (c.next = 51), c.t19.awrap.call(c.t19, c.t22);
                  case 51:
                    return (
                      (c.t23 = c.sent),
                      c.t18.push.call(c.t18, c.t23),
                      (c.t24 = r),
                      (c.t25 = regeneratorRuntime),
                      (c.t26 = n.Redactor),
                      (c.next = 58),
                      regeneratorRuntime.awrap(n.Rect.init(300, 300, 400, 400))
                    );
                  case 58:
                    return (c.t27 = c.sent), (c.t28 = c.t26.redactionCreate.call(c.t26, 2, c.t27, !1, '')), (c.next = 62), c.t25.awrap.call(c.t25, c.t28);
                  case 62:
                    return (
                      (c.t29 = c.sent),
                      c.t24.push.call(c.t24, c.t29),
                      (c.t30 = r),
                      (c.t31 = regeneratorRuntime),
                      (c.t32 = n.Redactor),
                      (c.next = 69),
                      regeneratorRuntime.awrap(n.Rect.init(500, 500, 600, 600))
                    );
                  case 69:
                    return (c.t33 = c.sent), (c.t34 = c.t32.redactionCreate.call(c.t32, 2, c.t33, !1, '')), (c.next = 73), c.t31.awrap.call(c.t31, c.t34);
                  case 73:
                    return (
                      (c.t35 = c.sent),
                      c.t30.push.call(c.t30, c.t35),
                      (c.t36 = r),
                      (c.t37 = regeneratorRuntime),
                      (c.t38 = n.Redactor),
                      (c.next = 80),
                      regeneratorRuntime.awrap(n.Rect.init(0, 0, 700, 20))
                    );
                  case 80:
                    return (c.t39 = c.sent), (c.t40 = c.t38.redactionCreate.call(c.t38, 3, c.t39, !1, '')), (c.next = 84), c.t37.awrap.call(c.t37, c.t40);
                  case 84:
                    return (c.t41 = c.sent), c.t36.push.call(c.t36, c.t41), (c.next = 88), regeneratorRuntime.awrap(n.ColorPt.init(0.1, 0.2, 0.6, 0));
                  case 88:
                    return (e = c.sent), (c.next = 91), regeneratorRuntime.awrap(n.Font.create(t, n.Font.StandardType1Font.e_times_roman));
                  case 91:
                    return (
                      (o = c.sent),
                      (i = { redaction_overlay: !0, positive_overlay_color: e, border: !1, font: o, show_redacted_content_regions: !0 }),
                      n.Redactor.redact(t, r, i, !1, !1),
                      (c.next = 96),
                      regeneratorRuntime.awrap(t.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 96:
                    (u = c.sent), saveBufferAsPDFDoc(u, 'redacted.pdf'), console.log('Done...'), (c.next = 105);
                    break;
                  case 101:
                    (c.prev = 101), (c.t42 = c.catch(2)), console.log(c.t42.stack), 1;
                  case 105:
                  case 'end':
                    return c.stop();
                }
