!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Dt),
        h(Ut, yt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        (j && (x = s(j.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || R(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : R(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (h) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === x) S = u(p, S, g);
              else {
  ...
  function(t, n) {
    !(function(t) {
      t.runElementEditTest = function() {
        var n = t.PDFNet;
        function r(t, e, o) {
          var i, u, c, a, f, s, l, p, h, v;
          return regeneratorRuntime.async(function(y) {
            for (;;)
              switch ((y.prev = y.next)) {
                case 0:
                  return (y.next = 2), regeneratorRuntime.awrap(n.startDeallocateStack());
                case 2:
                  return (y.next = 4), regeneratorRuntime.awrap(n.ColorSpace.createDeviceRGB());
                case 4:
                  return (i = y.sent), (y.next = 7), regeneratorRuntime.awrap(n.ColorPt.init(1, 0, 0, 0));
                case 7:
                  return (u = y.sent), (y.next = 10), regeneratorRuntime.awrap(n.ColorPt.init(0, 0, 1, 0));
                case 10:
                  return (c = y.sent), (y.next = 13), regeneratorRuntime.awrap(t.next());
                case 13:
                  a = y.sent;
                case 14:
                  if (null === a) {
                  ...
                  return (y.next = 17), regeneratorRuntime.awrap(a.getType());
                case 17:
                  (f = y.sent),
                    (s = void 0),
                    (l = void 0),
                    ...
                    (y.t0 = f),
                    (y.next =
                      y.t0 === n.Element.Type.e_image
                        ? 24
                        : y.t0 === n.Element.Type.e_inline_image
                        ? 24
                        : y.t0 === n.Element.Type.e_path
                        ? 25
                        : y.t0 === n.Element.Type.e_text
                        ? 32
                        : y.t0 === n.Element.Type.e_form
                        ? 39
                        : 59);
                  break;
                case 24:
                  return y.abrupt('break', 60);
                case 25:
                  return (y.next = 27), regeneratorRuntime.awrap(a.getGState());
                case 27:
                  return (s = y.sent).setFillColorSpace(i), s.setFillColorWithColorPt(u), e.writeElement(a), y.abrupt('break', 60);
                case 32:
                  return (y.next = 34), regeneratorRuntime.awrap(a.getGState());
                case 34:
                  return (s = y.sent).setFillColorSpace(i), s.setFillColorWithColorPt(c), e.writeElement(a), y.abrupt('break', 60);
                case 39:
                  return e.writeElement(a), (y.next = 42), regeneratorRuntime.awrap(a.getXObject());
                case 42:
                  if (((l = y.sent), (p = l.getObjNum()), -1 !== o.indexOf(p))) {
                    y.next = 58;
                    break;
                  }
                  return (y.next = 47), regeneratorRuntime.awrap(l.getObjNum());
                case 47:
                  return (h = y.sent), o.includes(h) || o.push(h), (y.next = 51), regeneratorRuntime.awrap(n.ElementWriter.create());
                case 51:
                  return (v = y.sent), t.formBegin(), v.beginOnObj(l, !0), (y.next = 56), regeneratorRuntime.awrap(r(t, v, o));
                case 56:
                  v.end(), t.end();
                case 58:
                  return y.abrupt('break', 60);
                case 59:
                  e.writeElement(a);
                case 60:
                  return (y.next = 62), regeneratorRuntime.awrap(t.next());
                case 62:
                  (a = y.sent), (y.next = 14);
                  break;
                case 65:
                  return (y.next = 67), regeneratorRuntime.awrap(n.endDeallocateStack());
                case 67:
                case 'end':
                  return y.stop();
              }
        ...
        n.runWithCleanup(function() {
          var t, e, o, i, u, c, a, f, s, l, p, h;
          return regeneratorRuntime.async(function(v) {
            for (;;)
              switch ((v.prev = v.next)) {
                case 0:
                  return console.log('Beginning Test'), (t = 0), '../TestFiles/', (v.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf'));
                case 5:
                  return (e = v.sent).initSecurityHandler(), e.lock(), console.log('PDF document initialized and locked'), (v.next = 11), regeneratorRuntime.awrap(n.ElementWriter.create());
                case 11:
                  return (o = v.sent), (v.next = 14), regeneratorRuntime.awrap(n.ElementReader.create());
                case 14:
                  return (i = v.sent), (u = []), (v.next = 18), regeneratorRuntime.awrap(e.getPageCount());
                case 18:
                  return (c = v.sent), (v.next = 21), regeneratorRuntime.awrap(e.getPageIterator(1));
                case 21:
                  a = v.sent;
                case 23:
                  return (v.next = 25), regeneratorRuntime.awrap(a.hasNext());
                case 25:
                  if (!v.sent) {
                    v.next = 49;
                    break;
                  }
                  return (v.next = 28), regeneratorRuntime.awrap(a.current());
                case 28:
                  return (f = v.sent), (v.next = 31), regeneratorRuntime.awrap(f.getIndex());
                case 31:
                  return (s = v.sent), console.log('Processing elements on page ' + s + '/' + c), (v.next = 35), regeneratorRuntime.awrap(f.getSDFObj());
                case 35:
                  return (l = v.sent), (v.next = 38), regeneratorRuntime.awrap(l.getObjNum());
                case 38:
                  return (p = v.sent), u.includes(p) || u.push(p), i.beginOnPage(f), o.beginOnPage(f, n.ElementWriter.WriteMode.e_replacement, !1), (v.next = 44), regeneratorRuntime.awrap(r(i, o, u));
                case 44:
                  o.end(), i.end();
                case 46:
                  a.next(), (v.next = 23);
                  break;
                case 49:
                  return (v.next = 51), regeneratorRuntime.awrap(e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused));
                case 51:
                  return (h = v.sent), saveBufferAsPDFDoc(h, 'newsletter_edited.pdf'), console.log('Done.'), v.abrupt('return', t);
                case 55:
                case 'end':
                  return v.stop();
              }
