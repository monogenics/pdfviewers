  ...
  function(t, n) {
    !(function(t) {
      var n = t.PDFNet,
            ...
            function(i) {
              for (;;)
                switch ((i.prev = i.next)) {
                  case 0:
                    return (i.prev = 0), (i.next = 3), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t));
                  case 3:
                    return (r = i.sent).initSecurityHandler(), r.lock(), (i.next = 8), regeneratorRuntime.awrap(r.getPageCount());
                  case 8:
                    return (e = i.sent), (i.next = 11), regeneratorRuntime.awrap(n.PDFDraw.create(100));
                  case 11:
                    return (o = i.sent), i.abrupt('return', { doc: r, pdfdraw: o, pagecount: e });
                  case 15:
                    (i.prev = 15), (i.t0 = i.catch(0)), console.log(i.t0.stack);
                  case 18:
                  case 'end':
                    return i.stop();
                }
        ...
        e = function(t, r) {
          var e, o, i, u, c, f, a, s, l, h;
          return regeneratorRuntime.async(
            function(p) {
              for (;;)
                switch ((p.prev = p.next)) {
                  case 0:
                    return (p.prev = 0), (e = t.doc), (o = t.pdfdraw), (p.next = 5), regeneratorRuntime.awrap(e.getPage(r));
                  case 5:
                    return (i = p.sent), (p.next = 8), regeneratorRuntime.awrap(o.getBitmap(i, n.PDFDraw.PixelFormat.e_rgba, !1));
                  case 8:
                    return (
                      (u = p.sent),
                      (c = u.width),
                      (f = u.height),
                      (a = new Uint8ClampedArray(u.buf)),
                      ((s = document.createElement('canvas')).width = c),
                      (s.height = f),
                      (l = s.getContext('2d')),
                      (h = l.createImageData(c, f)).data.set(a),
                      l.putImageData(h, 0, 0),
                      p.abrupt('return', s)
                    );
                  case 22:
                    (p.prev = 22), (p.t0 = p.catch(0)), console.log(p.t0.stack);
                  case 25:
                  case 'end':
                    return p.stop();
                }
      ...
      (t.loadDocument = function(t) {
        return n.runWithoutCleanup(function() {
