!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        At(Gt, 'buffer', 'b'),
        At(Gt, 'byteOffset', 'o'),
        At(Gt, 'byteLength', 'l'),
        At(Gt, 'length', 'e'),
    ...
    var o = r(1),
      ...
      H =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(U, n);
              e && delete U[n], R(t, n, r), e && t !== U && R(U, n, e);
            }
          : R,
      $ = function(t) {
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || R(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : R(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
                ...
                return (
                  n.push({
                    ...
                    states: {
                          ...
                          n('disabled'),
                            (function(t) {
                              ...
                              return (
                                  ...
                                  return regeneratorRuntime.async(function(y) {
                                    for (;;)
                                      switch ((y.prev = y.next)) {
                                        case 0:
                                          return (y.next = 2), regeneratorRuntime.awrap(r.startDeallocateStack());
                                        case 2:
                                          return console.log('Processing elements'), (y.next = 5), regeneratorRuntime.awrap(r.ColorSpace.createDeviceRGB());
                                        case 5:
                                          return (c = y.sent), (y.next = 8), regeneratorRuntime.awrap(r.ColorPt.init(1, 0, 0, 0));
                                        case 8:
                                          return (a = y.sent), (y.next = 11), regeneratorRuntime.awrap(r.ColorPt.init(0, 0, 1, 0));
                                        case 11:
                                          return (f = y.sent), (y.next = 14), regeneratorRuntime.awrap(t.next());
                                        case 14:
                                          i = y.sent;
                                        case 15:
                                          if (null === i) {
                                          ...
                                          return (y.next = 18), regeneratorRuntime.awrap(i.getType());
                                        case 18:
                                          (s = y.sent),
                                            (l = void 0),
                                            (h = void 0),
                                            ...
                                            (y.t0 = s),
                                            (y.next =
                                              y.t0 === r.Element.Type.e_image
                                                ? 26
                                                : y.t0 === r.Element.Type.e_inline_image
                                                ? 26
                                                : y.t0 === r.Element.Type.e_path
                                                ? 27
                                                : y.t0 === r.Element.Type.e_text
                                                ? 35
                                                : y.t0 === r.Element.Type.e_form
                                                ? 43
                                                : 65);
                                          break;
                                        case 26:
                                          return y.abrupt('break', 67);
                                        case 27:
                                          return (y.next = 29), regeneratorRuntime.awrap(i.getGState());
                                        case 29:
                                          return (u = y.sent).setFillColorSpace(c), u.setFillColorWithColorPt(a), (y.next = 34), regeneratorRuntime.awrap(e.writeElement(i));
                                        case 34:
                                          return y.abrupt('break', 67);
                                        case 35:
                                          return (y.next = 37), regeneratorRuntime.awrap(i.getGState());
                                        case 37:
                                          return (u = y.sent).setFillColorSpace(c), u.setFillColorWithColorPt(f), (y.next = 42), regeneratorRuntime.awrap(e.writeElement(i));
                                        case 42:
                                          return y.abrupt('break', 67);
                                        case 43:
                                          return (y.next = 45), regeneratorRuntime.awrap(e.writeElement(i));
                                        case 45:
                                          return (y.next = 47), regeneratorRuntime.awrap(i.getXObject());
                                        case 47:
                                          if (((l = y.sent), (h = l.getObjNum()), -1 !== o.indexOf(h))) {
                                            y.next = 64;
                                            break;
                                          }
                                          return (y.next = 52), regeneratorRuntime.awrap(l.getObjNum());
                                        case 52:
                                          return (p = y.sent), o.includes(p) || o.push(p), (y.next = 56), regeneratorRuntime.awrap(r.ElementWriter.create());
                                        case 56:
                                          return (v = y.sent), t.formBegin(), v.beginOnObj(l, !0), (y.next = 61), regeneratorRuntime.awrap(n(t, v, o));
                                        case 61:
                                          v.end(), t.end(), v && v.destroy();
                                        case 64:
                                          return y.abrupt('break', 67);
                                        case 65:
                                          return (y.next = 67), regeneratorRuntime.awrap(e.writeElement(i));
                                        case 67:
                                          return (y.next = 69), regeneratorRuntime.awrap(t.next());
                                        case 69:
                                          (i = y.sent), (y.next = 15);
                                          break;
                                        case 72:
                                          return (y.next = 74), regeneratorRuntime.awrap(r.endDeallocateStack());
                                        case 74:
                                        case 'end':
                                          return y.stop();
                                      }
                                ...
                                r.runWithCleanup(function() {
                                  var e, o, i, u, c, a, f, s, l, h;
                                  return regeneratorRuntime.async(
                                    function(p) {
                                      for (;;)
                                        switch ((p.prev = p.next)) {
                                          case 0:
                                            return (e = 0), (p.prev = 1), (o = t).lock(), o.initSecurityHandler(), (p.next = 9), regeneratorRuntime.awrap(r.ElementWriter.create());
                                          case 9:
                                            return (i = p.sent), (p.next = 12), regeneratorRuntime.awrap(r.ElementReader.create());
                                          case 12:
                                            return (u = p.sent), (c = []), (p.next = 16), regeneratorRuntime.awrap(o.getPageCount());
                                          case 16:
                                            (a = p.sent), (f = 1);
                                          case 18:
                                            if (!(f <= a)) {
                                            ...
                                            return o.unlock(), (p.next = 22), regeneratorRuntime.awrap(r.finishOperation());
                                          case 22:
                                            return (p.next = 24), regeneratorRuntime.awrap(o.requirePage(f));
                                          case 24:
                                            return (p.next = 26), regeneratorRuntime.awrap(r.beginOperation());
                                          case 26:
                                            return o.lock(), (p.next = 29), regeneratorRuntime.awrap(o.getPage(f));
                                          case 29:
                                            return (s = p.sent), (p.next = 32), regeneratorRuntime.awrap(s.getSDFObj());
                                          case 32:
                                            return (l = p.sent), (p.next = 35), regeneratorRuntime.awrap(l.getObjNum());
                                          case 35:
                                            return (
                                              (h = p.sent),
                                              c.includes(h) || c.push(h),
                                              u.beginOnPage(s),
                                              i.beginOnPage(s, r.ElementWriter.WriteMode.e_replacement, !1),
                                              (p.next = 41),
                                              regeneratorRuntime.awrap(n(u, i, c))
                                            );
                                          case 41:
                                            i.end(), u.end(), console.log('page ' + f + ' finished editing'), f++, (p.next = 18);
                                            break;
                                          case 47:
                                            console.log('Done.'), (p.next = 54);
                                            break;
                                          case 50:
                                            (p.prev = 50), (p.t0 = p.catch(1)), console.log(p.t0.stack), (e = 1);
                                          case 54:
                      ...
                      disabled: { img: e('lightgray'), onClick: function() {} },
                    },
                  }),
                  n
                );
