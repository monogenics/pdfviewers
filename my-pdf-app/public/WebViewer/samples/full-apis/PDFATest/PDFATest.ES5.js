  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: g ? P : S('keys'), entries: A }), d)) for (b in m) b in F || i(F, b, m[b]);
    ...
    !(function(t) {
      t.runPDFA = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, f, a, s, l, h, p, v, y, g, d, m, b;
                ...
                switch ((x.prev = x.next)) {
                  case 0:
                    return (
                      ...
                      10,
                      !1,
                      (r = '../TestFiles/' + (t = 'newsletter.pdf')),
                      (x.next = 11),
                      regeneratorRuntime.awrap(n.PDFACompliance.createFromUrl(!1, r, '', n.PDFACompliance.Conformance.e_Level1B, void 0, 10, !1))
                    );
                  case 11:
                    return (e = x.sent), (x.next = 14), regeneratorRuntime.awrap(e.getErrorCount());
                  case 14:
                    if (0 !== (o = x.sent)) {
                      x.next = 19;
                      break;
                    }
                    console.log(t + ' is a valid PDFA.'), (x.next = 46);
                    break;
                  case 19:
                    console.log(t + ' is NOT a valid PDFA.'), (i = 0);
                  case 21:
                    if (!(i < o)) {
                      x.next = 46;
                      break;
                    }
                    return (x.next = 24), regeneratorRuntime.awrap(e.getError(i));
                  case 24:
                    return (u = x.sent), (x.next = 27), regeneratorRuntime.awrap(n.PDFACompliance.getPDFAErrorMessage(u));
                  case 27:
                    return (c = x.sent), (x.next = 30), regeneratorRuntime.awrap(e.getRefObjCount(u));
                  case 30:
                    if (!((f = x.sent) > 0)) {
                      x.next = 43;
                      break;
                  ...
                  case 34:
                    ...
                    return (x.next = 37), regeneratorRuntime.awrap(e.getRefObj(u, s));
                  case 37:
                    (l = x.sent), a.push(l);
                  case 39:
                    s++, (x.next = 34);
                    break;
                  case 42:
                    console.log('Error:' + c + '. Objects:' + a.toString());
                  case 43:
                    i++, (x.next = 21);
                    break;
                  case 46:
                    ...
                    break;
                  case 48:
                    (x.prev = 48), (x.t0 = x.catch(0)), console.log(x.t0);
                  case 51:
                    return (
                      (x.prev = 51),
                      ...
                      (v = ''),
                      (y = 10),
                      (g = '../TestFiles/' + (h = 'fish.pdf')),
                      console.log('Converting input document: ' + h),
                      (x.next = 63),
                      regeneratorRuntime.awrap(n.PDFACompliance.createFromUrl(!0, g, v, n.PDFACompliance.Conformance.e_Level1B, void 0, y))
                    );
                  case 63:
                    return (d = x.sent), (x.next = 66), regeneratorRuntime.awrap(d.getErrorCount());
                  case 66:
                    return (
                      0 === x.sent ? console.log(h + ' is a valid PDFA.') : console.log(h + ' is NOT a valid PDFA.'),
                      console.log('Save and validate the converted document: ' + p),
                      !0,
                      (x.next = 72),
                      regeneratorRuntime.awrap(d.saveAsFromBuffer(!0))
                    );
                  case 72:
                    return (
                      (m = x.sent),
                      saveBufferAsPDFDoc(m, p),
                      !1,
                      (x.next = 77),
                      regeneratorRuntime.awrap(n.PDFACompliance.createFromBuffer(!1, m, v, n.PDFACompliance.Conformance.e_Level1B, void 0, y))
                    );
                  case 77:
                    return (b = x.sent), (x.next = 80), regeneratorRuntime.awrap(b.getErrorCount());
                  case 80:
                    0 === x.sent ? console.log(p + ' is a valid PDFA.') : console.log(p + ' is NOT a valid PDFA.'), (x.next = 87);
                    break;
                  case 84:
                    (x.prev = 84), (x.t1 = x.catch(51)), console.log(x.t1);
                  case 87:
                  case 'end':
                    return x.stop();
                }
