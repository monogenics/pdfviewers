!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        jt(Ut, 'buffer', 'b'),
        jt(Ut, 'byteOffset', 'o'),
        jt(Ut, 'byteLength', 'l'),
        jt(Ut, 'length', 'e'),
          ...
          return regeneratorRuntime.async(function(f) {
            for (;;)
              switch ((f.prev = f.next)) {
                case 0:
                  return console.log('Beginning Test'), (t = 0), '../TestFiles/', (f.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf'));
                case 5:
                  return (r = f.sent).initSecurityHandler(), r.lock(), console.log('PDFNet and PDF document initialized and locked'), (f.next = 11), regeneratorRuntime.awrap(n.PDFDraw.create(92));
                case 11:
                  return (e = f.sent), (f.next = 14), regeneratorRuntime.awrap(r.getPageIterator(1));
                case 14:
                  return (o = f.sent), (f.next = 17), regeneratorRuntime.awrap(o.current());
                case 17:
                  return (i = f.sent), (f.next = 20), regeneratorRuntime.awrap(e.exportStream(i, 'PNG'));
                case 20:
                  return (u = f.sent), saveBufferAsPNG(u, 'newsletter.png'), (f.next = 24), regeneratorRuntime.awrap(e.exportStream(i, 'TIFF'));
                case 24:
                  return (c = f.sent), saveBufferAsPNG(c, 'newsletter.tif'), console.log('Done'), f.abrupt('return', t);
                case 28:
                case 'end':
                  return f.stop();
              }
