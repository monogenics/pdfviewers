!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var g, y, d = i(n), x = o(d), m = r(c, v, 3), b = u(x.length), w = 0, S = e ? h(n, b) : a ? h(n, 0) : void 0; b > w; w++)
          if ((p || w in x) && ((y = m((g = x[w]), w, d)), t))
            if (e) S[w] = y;
            else if (y)
              switch (t) {
                case 3:
    ...
    if (e(8)) {
      var o = e(30),
        ...
        It = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, e = y(c.length), o = Ft(this, e); e > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        jt = function() {
        ...
        Nt = {
          ...
          subarray: function(t, n) {
            var e = Ot(this),
              r = e.length,
              o = x(t, r);
            return new (k(e, e[xt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, y((void 0 === n ? r : x(n, r)) - o));
          },
        },
        Lt = function(t, n) {
          return Pt(this, pt.call(Ot(this), t, n));
        },
        Dt = function(t) {
          Ot(this);
        ...
        Bt = function(t, n) {
          return Ct(t, (n = m(n, !0))) ? p(2, t[n]) : U(t, n);
        },
        Vt = function(t, n, e) {
          return !(Ct(t, (n = m(n, !0))) && S(e) && b(e, 'value')) || b(e, 'get') || b(e, 'set') || e.configurable || (b(e, 'writable') && !e.writable) || (b(e, 'enumerable') && !e.enumerable)
            ? G(t, n, e)
            : ((t[n] = e.value), t);
        };
      mt || ((V.f = Bt), (B.f = Vt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Bt, defineProperty: Vt }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
      ...
      v(Gt, Wt),
        h(Gt, gt, Wt.values),
        v(Gt, { slice: Lt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        At(Gt, 'buffer', 'b'),
        At(Gt, 'byteOffset', 'o'),
        At(Gt, 'byteLength', 'l'),
        At(Gt, 'length', 'e'),
          ...
          m
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (S(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = w(e)) || 'SharedArrayBuffer' == a)) return bt in e ? Mt(v, e) : It.call(v, e);
                  (i = e), (p = Rt(r, n));
                  var g = e.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              K(x !== Function.prototype ? F(g).concat(F(x)) : F(g), function(t) {
                t in v || h(v, t, g[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, e) {
    ...
    ((n = t.exports = function(t, n, e, l, p) {
      ...
      if (i(d)) {
        for (h = c(t.length); h > m; m++) if ((y = n ? x(u((v = t[m]))[0], v[1]) : x(t[m])) === f || y === s) return y;
      } else for (g = d.call(t); !(v = g.next()).done; ) if ((y = o(g, x, v.value, n)) === f || y === s) return y;
    }).BREAK = f),
      (n.RETURN = s);
  },
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, g, y, d) {
      ...
      if (
        ...
        F ||
          ...
          (w.constructor = m)),
          (O || P) && (_('delete'), _('has'), y && _('get')),
          (P || R) && _(b),
          d && w.clear && delete w.clear;
      } else (m = g.getConstructor(n, t, y, b)), u(m.prototype, e), (c.NEED = !0);
      return h(m, t), (S[t] = m), o(o.G + o.W + o.F * (m != x), S), d || g.setStrong(m, t, y), m;
    };
  },
  function(t, n, e) {
    for (
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, g, y, d) {
      ...
      var x,
        ...
        E = !1,
        R = t.prototype,
        O = R[l] || R['@@iterator'] || (g && R[g]),
        F = O || w(g),
        P = g ? (_ ? w('entries') : F) : void 0,
        M = ('Array' == n && R.entries) || O;
      if (
        ...
        if (((x = { values: _ ? F : w('values'), keys: y ? F : w('keys'), entries: P }), d)) for (m in x) m in R || i(R, m, x[m]);
  ...
  function(t, n, e) {
    ...
    function z(t, n, e, r, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[k], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var r,
      ...
      I = !!(function() {
        try {
          ...
          return (P || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== O.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
      ...
      T = function(t) {
        d.call(a, function() {
          ...
          if (
            (i &&
              ((n = b(function() {
                P ? E.emit('unhandledRejection', o, t) : (e = a.onunhandledrejection) ? e({ promise: t, reason: o }) : (r = a.console) && r.error && r.error('Unhandled promise rejection', o);
              })),
              (t._h = P || N(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      K = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          m(e),
          i(V, n) ? (e.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (e = R(e, { enumerable: E(0, !1) }))) : (i(t, D) || j(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, e)) : j(t, n, e)
        );
      },
      J = function(t, n) {
        m(t);
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== U || !i(V, n) || i(G, n))) {
          var e = I(t, n);
          return !e || !i(V, n) || (i(t, D) && t[D][n]) || (e.enumerable = !0), e;
        }
      },
      tt = function(t) {
        for (var n, e = k(S(t)), r = [], o = 0; e.length > o; ) i(V, (n = e[o++])) || n == D || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === U, r = k(e ? G : S(t)), o = [], u = 0; r.length > u; ) !i(V, (n = r[u++])) || (e && !i(U, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      T.prototype[W] || e(14)(T.prototype, W, T.prototype.valueOf),
      p(T, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            x = s(p);
          if ((y && (g = r(g, v > 2 ? arguments[2] : void 0, 2)), null == x || (h == Array && c(x)))) for (e = new h((n = a(p.length))); n > d; d++) f(e, d, y ? g(p[d], d) : p[d]);
          else for (l = x.call(p), e = new h(); !(o = l.next()).done; d++) f(e, d, y ? u(l, g, [o.value, d], !0) : o.value);
          return (e.length = d), e;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x = []; ; ) {
            ...
            if (null === m) break;
            if ((x.push(m), !y)) break;
            '' === String(m[0]) && (l.lastIndex = c(p, i(l.lastIndex), d));
          }
          for (var b, w = '', S = 0, _ = 0; _ < x.length; _++) {
            m = x[_];
            for (var E = String(m[0]), R = f(s(u(m.index), p.length), 0), O = [], F = 1; F < m.length; F++) O.push(void 0 === (b = m[F]) ? b : String(b));
            var P = m.groups;
            if (h) {
              var M = [E].concat(O, R, p);
              void 0 !== P && M.push(P);
              var A = String(n.apply(void 0, M));
            } else A = g(E, p, R, O, P, n);
            R >= S && ((w += p.slice(S, R) + A), (S = R + E.length));
          }
          return w + p.slice(S);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, w = 0, S = []; w < p.length; ) {
              ...
              var _,
                E = a(x, h ? p : p.slice(w));
              if (null === E || (_ = l(c(x.lastIndex + (h ? 0 : w)), p.length)) === b) w = u(p, w, y);
              else {
                if ((S.push(p.slice(b, w)), S.length === m)) return S;
                for (var R = 1; R <= E.length - 1; R++) if ((S.push(E[R]), S.length === m)) return S;
                w = b = _;
              }
            }
  ...
  function(t, n, e) {
    ...
    t.exports = function t(n, e, a, f, s, l, p, h) {
      for (var v, g, y = s, d = 0, x = !!p && u(p, h, 3); d < f; ) {
        if (d in a) {
  ...
  function(t, n, e) {
    for (
      ...
      var y,
        ...
        m = u[d],
        b = m && m.prototype;
      if (b && (b[s] || c(b, s, p), b[l] || c(b, l, d), (a[d] = p), x)) for (y in r) b[y] || i(b, y, r[y], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
        ...
        function R(t, n) {
          ...
          if (r === e) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = e), R(t, n), 'throw' === n.method)) return g;
          ...
          ((s = !p && b && void 0 !== b[f]) && c(x, f)) ||
            ...
            (x[f] =
              h && 'function' != typeof b[f]
                ...
                ? i(Function.call, l)
                : l),
            g && (((x.virtual || (x.virtual = {}))[f] = l), n & t.R && m && !m[f] && u(m, f, l)));
      };
                ...
                (t = function t(e) {
                  ...
                  return regeneratorRuntime.async(function(u) {
                    for (;;)
                      switch ((u.prev = u.next)) {
                        case 0:
                          return (u.next = 2), regeneratorRuntime.awrap(e.next());
                        case 2:
                          if (((u.t0 = r = u.sent), null === u.t0)) {
                            u.next = 30;
                            break;
                          }
                          return (u.next = 6), regeneratorRuntime.awrap(r.getType());
                        case 6:
                          (u.t1 = u.sent),
                            (u.next =
                              u.t1 === n.Element.Type.e_text_begin
                                ? 9
                                : u.t1 === n.Element.Type.e_text_end
                                ? 11
                                : u.t1 === n.Element.Type.e_text
                                ? 13
                                : u.t1 === n.Element.Type.e_text_new_line
                                ? 22
                                : u.t1 === n.Element.Type.e_form
                                ? 23
                                : 28);
                          break;
                        case 9:
                          return console.log('--\x3e Text Block Begin'), u.abrupt('break', 28);
                        case 11:
                          return console.log('--\x3e Text Block End'), u.abrupt('break', 28);
                        case 13:
                          return (u.next = 15), regeneratorRuntime.awrap(r.getBBox());
                        case 15:
                          return (o = u.sent), console.log('--\x3e BBox: ' + o.x1 + ', ' + o.y1 + ', ' + o.x2 + ', ' + o.y2 + '\n'), (u.next = 19), regeneratorRuntime.awrap(r.getTextString());
                        case 19:
                          return (i = u.sent), console.log(i), u.abrupt('break', 28);
                        case 22:
                          return u.abrupt('break', 28);
                        case 23:
                          return e.formBegin(), (u.next = 26), regeneratorRuntime.awrap(t(e));
                        case 26:
                          return e.end(), u.abrupt('break', 28);
                        case 28:
                          u.next = 0;
                          break;
                        case 30:
                    ...
                    return regeneratorRuntime.async(function(a) {
                      for (;;)
                        switch ((a.prev = a.next)) {
                          case 0:
                            return (a.next = 2), regeneratorRuntime.awrap(e.next());
                          case 2:
                            if (((a.t0 = i = a.sent), null === a.t0)) {
                              a.next = 31;
                              break;
                            }
                            return (c = void 0), (a.next = 7), regeneratorRuntime.awrap(i.getType());
                          case 7:
                            (a.t1 = a.sent), (a.next = a.t1 === n.Element.Type.e_text ? 10 : a.t1 === n.Element.Type.e_text_new_line ? 21 : a.t1 === n.Element.Type.e_form ? 22 : 29);
                            break;
                          case 10:
                            return (a.next = 12), regeneratorRuntime.awrap(i.getBBox());
                          case 12:
                            return (c = a.sent), (a.next = 15), regeneratorRuntime.awrap(c.intersectRect(c, r));
                          case 15:
                            if (!a.sent) {
                              a.next = 20;
                              break;
                            }
                            return (a.next = 18), regeneratorRuntime.awrap(i.getTextString());
                          case 18:
                            (u = a.sent), (o += u + '\n');
                          case 20:
                          case 21:
                            return a.abrupt('break', 29);
                          case 22:
                            return e.formBegin(), (a.t2 = o), (a.next = 26), regeneratorRuntime.awrap(t(e, r, o));
                          case 26:
                            return (o = a.t2 += a.sent), e.end(), a.abrupt('break', 29);
                          case 29:
                            a.next = 0;
                            break;
                          case 31:
                    ...
                    return regeneratorRuntime.async(function(i) {
                      for (;;)
                        switch ((i.prev = i.next)) {
                          case 0:
                            return (o = ''), r.beginOnPage(t), (i.t0 = o), (i.next = 5), regeneratorRuntime.awrap(e(r, n, o));
                          case 5:
                            return (o = i.t0 += i.sent), r.end(), i.abrupt('return', o);
                          case 8:
                          case 'end':
                            return i.stop();
                        }
                    ...
                    return regeneratorRuntime.async(function(f) {
                      for (;;)
                        switch ((f.prev = f.next)) {
                          case 0:
                            return (f.next = 2), regeneratorRuntime.awrap(t.getColor());
                          case 2:
                            return (n = f.sent), (f.next = 5), regeneratorRuntime.awrap(n.get(0));
                          case 5:
                            return (e = f.sent), (f.next = 8), regeneratorRuntime.awrap(n.get(1));
                          case 8:
                            return (r = f.sent), (f.next = 11), regeneratorRuntime.awrap(n.get(2));
                          case 11:
                            return (o = f.sent), (f.next = 14), regeneratorRuntime.awrap(t.getFontName());
                          case 14:
                            return (i = f.sent), (f.next = 17), regeneratorRuntime.awrap(t.getFontSize());
                          case 17:
                            return (u = f.sent), (f.next = 20), regeneratorRuntime.awrap(t.isSerif());
                          case 20:
                            if (!f.sent) {
                              f.next = 24;
                              break;
                            }
                            (f.t0 = ' sans-serif; '), (f.next = 25);
                            break;
                          case 24:
                            f.t0 = ' ';
                          case 25:
                            return (
                              (c = f.t0),
                              (a = 'style="font-family:' + i + ';font-size:' + u + ';' + c + 'color: #' + e.toString(16) + ', ' + r.toString(16) + ', ' + o.toString(16) + ')"'),
                              f.abrupt('return', a)
                            );
                          case 28:
                          case 'end':
                  ...
                  (i = function() {
                    var e, i, u, c, a, f, s, l, p, h, v, g, y, d, x, m, b, w, S, _, E, R, O, F, P, M, A, I, j, k;
                          ...
                          switch ((T.prev = T.next)) {
                            case 0:
                              return (
                                ...
                                (T.prev = 10),
                                (T.next = 13),
                                regeneratorRuntime.awrap(n.startDeallocateStack())
                              );
                            case 13:
                              return (T.next = 15), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(e + i));
                            case 15:
                              return (l = T.sent).initSecurityHandler(), l.lock(), (T.next = 20), regeneratorRuntime.awrap(l.getPage(1));
                            case 20:
                              if ('0' !== (p = T.sent).id) {
                                T.next = 24;
                                break;
                            ...
                            case 24:
                              return (T.next = 26), regeneratorRuntime.awrap(n.TextExtractor.create());
                            case 26:
                              return (h = T.sent), (v = new n.Rect(0, 0, 612, 794)), h.begin(p, v), (T.next = 31), regeneratorRuntime.awrap(h.getNumLines());
                            case 31:
                              if ((T.sent, !u)) {
                                T.next = 43;
                                break;
                              }
                              return (T.next = 35), regeneratorRuntime.awrap(h.getWordCount());
                            case 35:
                              return (x = T.sent), console.log('Word Count: ' + x), (T.next = 39), regeneratorRuntime.awrap(h.getAsText());
                            case 39:
                            ...
                            case 43:
                              ...
                              return (
                                ...
                                regeneratorRuntime.awrap(
                                  h.getAsXML(n.TextExtractor.XMLOutputFlags.e_words_as_elements | n.TextExtractor.XMLOutputFlags.e_output_bbox | n.TextExtractor.XMLOutputFlags.e_output_style_info)
                                )
                              );
                            case 46:
                            ...
                            case 49:
                              ...
                              return (T.next = 52), regeneratorRuntime.awrap(h.getFirstLine());
                            case 52:
                              y = T.sent;
                            case 53:
                              return (T.next = 55), regeneratorRuntime.awrap(y.isValid());
                            case 55:
                              if (!T.sent) {
                                T.next = 76;
                                break;
                              }
                              return (T.next = 58), regeneratorRuntime.awrap(y.getFirstWord());
                            case 58:
                              d = T.sent;
                            case 59:
                              return (T.next = 61), regeneratorRuntime.awrap(d.isValid());
                            case 61:
                              if (!T.sent) {
                                T.next = 71;
                                break;
                              }
                              return (T.next = 64), regeneratorRuntime.awrap(d.getString());
                            case 64:
                              (g = T.sent), console.log(g);
                            case 66:
                              return (T.next = 68), regeneratorRuntime.awrap(d.getNextWord());
                            case 68:
                              (d = T.sent), (T.next = 59);
                              break;
                            case 71:
                              return (T.next = 73), regeneratorRuntime.awrap(y.getNextLine());
                            case 73:
                              (y = T.sent), (T.next = 53);
                              break;
                            case 76:
                            ...
                            case 77:
                              ...
                              return (w = -1), (S = -1), (T.next = 82), regeneratorRuntime.awrap(n.ElementBuilder.create());
                            case 82:
                              return T.sent, (T.next = 85), regeneratorRuntime.awrap(n.ElementWriter.create());
                            case 85:
                              return T.sent, (T.next = 88), regeneratorRuntime.awrap(h.getFirstLine());
                            case 88:
                              y = T.sent;
                            case 89:
                              return (T.next = 91), regeneratorRuntime.awrap(y.isValid());
                            case 91:
                              if (!T.sent) {
                                T.next = 181;
                                break;
                              }
                              return (T.next = 94), regeneratorRuntime.awrap(y.getNumWords());
                            case 94:
                            ...
                            case 97:
                              return (T.next = 99), regeneratorRuntime.awrap(y.getFlowID());
                            case 99:
                              if (((T.t1 = T.sent), (T.t2 = w), T.t1 === T.t2)) {
                                T.next = 107;
                                break;
                              }
                              return -1 !== w && (-1 !== S && ((S = -1), console.log('</Para>')), console.log('</Flow>')), (T.next = 105), regeneratorRuntime.awrap(y.getFlowID());
                            case 105:
                              (w = T.sent), console.log('<Flow id="' + w + '">');
                            case 107:
                              return (T.next = 109), regeneratorRuntime.awrap(y.getParagraphID());
                            case 109:
                              if (((T.t3 = T.sent), (T.t4 = S), T.t3 === T.t4)) {
                                T.next = 117;
                                break;
                              }
                              return -1 !== S && console.log('</Para>'), (T.next = 115), regeneratorRuntime.awrap(y.getParagraphID());
                            case 115:
                              (S = T.sent), console.log('<Para id="' + S + '">');
                            case 117:
                              return (T.next = 119), regeneratorRuntime.awrap(y.getBBox());
                            case 119:
                              return (m = T.sent), (T.next = 122), regeneratorRuntime.awrap(y.getStyle());
                            case 122:
                              return (_ = T.sent), (E = '<Line box="' + m.x1 + ', ' + m.y1 + ', ' + m.x2 + ', ' + m.y1 + '">'), (T.t5 = E), (T.next = 127), regeneratorRuntime.awrap(o(_));
                            case 127:
                              return (E = T.t5 += T.sent), (T.next = 130), regeneratorRuntime.awrap(y.getCurrentNum());
                            case 130:
                              return (R = T.sent), (E += ' cur_num="' + R + '">'), console.log(E), (O = ''), (T.next = 136), regeneratorRuntime.awrap(y.getFirstWord());
                            case 136:
                              d = T.sent;
                            case 137:
                              return (T.next = 139), regeneratorRuntime.awrap(d.isValid());
                            case 139:
                              if (!T.sent) {
                                T.next = 175;
                                break;
                              }
                              return (T.next = 142), regeneratorRuntime.awrap(d.getBBox());
                            case 142:
                              return (b = T.sent), (T.next = 145), regeneratorRuntime.awrap(d.getCurrentNum());
                            case 145:
                              return (
                                (F = T.sent),
                                (O += '<Word box="' + b.x1 + ', ' + b.y1 + ', ' + b.x2 + ', ' + b.y2 + '" cur_num="' + F + '"'),
                                (T.next = 149),
                                regeneratorRuntime.awrap(d.getStringLen())
                              );
                            case 149:
                              if (0 !== T.sent) {
                                T.next = 152;
                            ...
                            case 152:
                              return (T.next = 154), regeneratorRuntime.awrap(d.getStyle());
                            case 154:
                              return (P = T.sent), (T.next = 157), regeneratorRuntime.awrap(P.compare(_));
                            case 157:
                              if (T.sent) {
                                T.next = 163;
                                break;
                              }
                              return (T.t6 = console), (T.next = 161), regeneratorRuntime.awrap(o(P));
                            case 161:
                              (T.t7 = T.sent), T.t6.log.call(T.t6, T.t7);
                            case 163:
                              return (T.t8 = O), (T.next = 166), regeneratorRuntime.awrap(d.getString());
                            case 166:
                              (T.t9 = T.sent), (T.t10 = '>' + T.t9), (O = T.t8 += T.t10 + '</Word>'), console.log(O);
                            case 170:
                              return (T.next = 172), regeneratorRuntime.awrap(d.getNextWord());
                            case 172:
                              (d = T.sent), (T.next = 137);
                              break;
                            case 175:
                              console.log('</Line>');
                            case 176:
                              return (T.next = 178), regeneratorRuntime.awrap(y.getNextLine());
                            case 178:
                              (y = T.sent), (T.next = 89);
                              break;
                            case 181:
                              -1 !== w && (-1 !== S && ((S = -1), console.log('</Para>')), console.log('</Flow>\n'));
                            case 182:
                              return console.log('done'), (T.next = 185), regeneratorRuntime.awrap(n.endDeallocateStack());
                            case 185:
                              T.next = 192;
                              break;
                            case 187:
                            ...
                            case 192:
                              ...
                              return 0, (T.prev = 194), (T.next = 197), regeneratorRuntime.awrap(n.startDeallocateStack());
                            case 197:
                              return (T.next = 199), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(e + i));
                            case 199:
                              return (l = T.sent).initSecurityHandler(), l.lock(), (T.next = 204), regeneratorRuntime.awrap(n.ElementReader.create());
                            case 204:
                              return (M = T.sent), (T.next = 207), regeneratorRuntime.awrap(l.getPageIterator(1));
                            case 207:
                              A = T.sent;
                            case 209:
                              return (T.next = 211), regeneratorRuntime.awrap(A.hasNext());
                            case 211:
                              if (!T.sent) {
                                T.next = 222;
                                break;
                              }
                              return (T.next = 214), regeneratorRuntime.awrap(A.current());
                            case 214:
                              return (I = T.sent), M.beginOnPage(I), (T.next = 218), regeneratorRuntime.awrap(t(M));
                            case 218:
                              M.end();
                            case 219:
                              A.next(), (T.next = 209);
                            ...
                            case 222:
                              return (
                                ...
                                console.log('----------------------------------------------------'),
                                (T.t12 = regeneratorRuntime),
                                (T.next = 228),
                                regeneratorRuntime.awrap(l.getPageIterator())
                              );
                            case 228:
                              return (T.t13 = T.sent.current()), (T.next = 231), T.t12.awrap.call(T.t12, T.t13);
                            case 231:
                              return (j = T.sent), (T.t14 = regeneratorRuntime), (T.t15 = r), (T.t16 = j), (T.next = 237), regeneratorRuntime.awrap(n.Rect.init(27, 392, 563, 534));
                            case 237:
                              return (T.t17 = T.sent), (T.t18 = M), (T.t19 = (0, T.t15)(T.t16, T.t17, T.t18)), (T.next = 242), T.t14.awrap.call(T.t14, T.t19);
                            case 242:
                              return (
                                (k = T.sent),
                                console.log('Field 1: ' + k),
                                (T.t20 = regeneratorRuntime),
                                (T.t21 = r),
                                (T.t22 = j),
                                (T.next = 249),
                                regeneratorRuntime.awrap(n.Rect.init(28, 551, 106, 623))
                              );
                            case 249:
                              return (T.t23 = T.sent), (T.t24 = M), (T.t25 = (0, T.t21)(T.t22, T.t23, T.t24)), (T.next = 254), T.t20.awrap.call(T.t20, T.t25);
                            case 254:
                              return (
                                (k = T.sent),
                                console.log('Field 2: ' + k),
                                (T.t26 = regeneratorRuntime),
                                (T.t27 = r),
                                (T.t28 = j),
                                (T.next = 261),
                                regeneratorRuntime.awrap(n.Rect.init(208, 550, 387, 621))
                              );
                            case 261:
                              return (T.t29 = T.sent), (T.t30 = M), (T.t31 = (0, T.t27)(T.t28, T.t29, T.t30)), (T.next = 266), T.t26.awrap.call(T.t26, T.t31);
                            case 266:
                              return (k = T.sent), console.log('Field 3: ' + k), console.log('Done'), (T.next = 271), regeneratorRuntime.awrap(n.endDeallocateStack());
                            case 271:
                              T.next = 277;
                              break;
                            case 273:
                              (T.prev = 273), (T.t32 = T.catch(194)), console.log(T.t32.stack), 1;
                            case 277:
                            case 'end':
                              return T.stop();
                          }
