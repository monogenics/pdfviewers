    ...
    var o = r(1),
      ...
      q =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = j(z, n);
              e && delete z[n], R(t, n, r), e && t !== z && R(z, n, e);
            }
          : R,
      $ = function(t) {
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, D) || R(t, D, O(1, {})), (t[D][n] = !0)), q(t, n, r)) : R(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
    ...
    !(function(t) {
      ...
      (t.runOptimizerTest = function() {
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, f, a, s, l, p, h, v, y;
          return regeneratorRuntime.async(
            function(g) {
              for (;;)
                switch ((g.prev = g.next)) {
                  case 0:
                    return (t = '../TestFiles/'), (r = 'newsletter'), (g.prev = 2), (g.next = 5), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + r + '.pdf'));
                  case 5:
                    return (e = g.sent).initSecurityHandler(), (g.next = 9), regeneratorRuntime.awrap(e.lock());
                  case 9:
                    return (g.next = 11), regeneratorRuntime.awrap(n.Optimizer.optimize(e));
                  case 11:
                    return (g.next = 13), regeneratorRuntime.awrap(e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 13:
                    (o = g.sent), saveBufferAsPDFDoc(o, r + '_opt1.pdf'), (g.next = 20);
                    break;
                  case 17:
                    (g.prev = 17), (g.t0 = g.catch(2)), console.log(g.t0);
                  case 20:
                    return (g.prev = 20), (g.next = 23), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + r + '.pdf'));
                  case 23:
                    return (i = g.sent).initSecurityHandler(), (g.next = 27), regeneratorRuntime.awrap(i.lock());
                  case 27:
                    return (
                      (u = new n.Optimizer.ImageSettings()).setCompressionMode(n.Optimizer.ImageSettings.CompressionMode.e_jpeg),
                      u.setQuality(1),
                      u.setImageDPI(144, 96),
                      u.forceRecompression(!0),
                      (c = new n.Optimizer.OptimizerSettings()).setColorImageSettings(u),
                      c.setGrayscaleImageSettings(u),
                      (g.next = 37),
                      regeneratorRuntime.awrap(n.Optimizer.optimize(i, c))
                    );
                  case 37:
                    return (g.next = 39), regeneratorRuntime.awrap(i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 39:
                    (f = g.sent), saveBufferAsPDFDoc(f, r + '_opt2.pdf'), (g.next = 46);
                    break;
                  case 43:
                    (g.prev = 43), (g.t1 = g.catch(20)), console.log(g.t1);
                  case 46:
                    return (g.prev = 46), (g.next = 49), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + r + '.pdf'));
                  case 49:
                    return (a = g.sent).initSecurityHandler(), (g.next = 53), regeneratorRuntime.awrap(a.lock());
                  case 53:
                    return (
                      (s = new n.Optimizer.MonoImageSettings()).setCompressionMode(n.Optimizer.MonoImageSettings.CompressionMode.e_jbig2),
                      s.forceRecompression(!0),
                      (l = new n.Optimizer.OptimizerSettings()).setMonoImageSettings(s),
                      (g.next = 60),
                      regeneratorRuntime.awrap(n.Optimizer.optimize(a, l))
                    );
                  case 60:
                    return (g.next = 62), regeneratorRuntime.awrap(a.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 62:
                    (p = g.sent), saveBufferAsPDFDoc(p, r + '_opt3.pdf'), (g.next = 69);
                    break;
                  case 66:
                    (g.prev = 66), (g.t2 = g.catch(46)), console.log(g.t2);
                  case 69:
                    return (g.prev = 69), (g.next = 72), regeneratorRuntime.awrap(n.PDFDoc.createFromURL(t + 'TigerText.pdf'));
                  case 72:
                    return (h = g.sent).initSecurityHandler(), (g.next = 76), regeneratorRuntime.awrap(h.lock());
                  case 76:
                    return (g.next = 78), regeneratorRuntime.awrap(n.Flattener.create());
                  case 78:
                    return (v = g.sent), (g.next = 81), regeneratorRuntime.awrap(v.process(h, n.Flattener.Mode.e_fast));
                  case 81:
                    return (g.next = 83), regeneratorRuntime.awrap(h.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 83:
                    (y = g.sent), saveBufferAsPDFDoc(y, 'TigerText_flatten.pdf'), (g.next = 90);
                    break;
                  case 87:
                    (g.prev = 87), (g.t3 = g.catch(69)), console.log(g.t3);
                  case 90:
                  case 'end':
                    return g.stop();
                }
