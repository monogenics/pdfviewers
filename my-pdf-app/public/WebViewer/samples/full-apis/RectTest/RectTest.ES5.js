                ...
                switch ((u.prev = u.next)) {
                  case 0:
                    return (
                      ...
                      '../TestFiles/',
                      (u.next = 6),
                      regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../TestFiles/tiger.pdf'))
                    );
                  case 6:
                    return (r = u.sent).initSecurityHandler(), r.lock(), console.log('PDF document initialized and locked'), (u.next = 12), regeneratorRuntime.awrap(r.getPageIterator());
                  case 12:
                    return (e = u.sent), (u.t0 = regeneratorRuntime), (u.next = 16), regeneratorRuntime.awrap(e.current());
                  case 16:
                    return (u.t1 = u.sent.getMediaBox()), (u.next = 19), u.t0.awrap.call(u.t0, u.t1);
                  case 19:
                    return ((o = u.sent).x1 -= 200), (o.x2 -= 200), (u.next = 24), regeneratorRuntime.awrap(o.update());
                  case 24:
                    return (u.next = 26), regeneratorRuntime.awrap(r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized));
                  case 26:
                    (i = u.sent), saveBufferAsPDFDoc(i, 'tiger_shift.pdf'), console.log('Done.'), (u.next = 35);
                    break;
                  case 31:
                    (u.prev = 31), (u.t2 = u.catch(1)), console.log(u.t2), (t = 1);
                  case 35:
