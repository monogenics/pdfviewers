          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (p = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw H('Wrong length!');
                    if ((u = y - p) < 0) throw H('Wrong length!');
                  } else if ((u = g(o) * n) + p > y) throw H('Wrong length!');
                  c = u / n;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: P(0, !1) }))) : (i(t, D) || I(t, D, P(1, {})), (t[D][n] = !0)), q(t, n, r)) : I(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else R = y(P, p, E, O, M, n);
            E >= w && ((S += p.slice(w, E) + R), (w = E + P.length));
          }
          return S + p.slice(w);
        },
      ];
    ...
    !(function(t) {
      t.runEncTest = function() {
        ...
        n.runWithCleanup(function() {
          var t, r, e, o, i, u, c, a, f, s, l, p, h, v, y, g, d, m, b, x, S, w, _, P, E;
                ...
                switch ((O.prev = O.next)) {
                  case 0:
                    return (
                      ...
                      !1,
                      (O.next = 9),
                      regeneratorRuntime.awrap(n.PDFDoc.createFromURL(r + 'fish.pdf'))
                    );
                  case 9:
                    return (
                      (e = O.sent).initSecurityHandler(),
                      e.lock(),
                      !0,
                      ...
                      (O.next = 19),
                      regeneratorRuntime.awrap(e.getTrailer())
                    );
                  case 19:
                    return (o = O.sent), (O.next = 22), regeneratorRuntime.awrap(o.get('Root'));
                  case 22:
                    return (i = O.sent), (O.next = 25), regeneratorRuntime.awrap(i.value());
                  case 25:
                    return (u = O.sent), (O.next = 28), regeneratorRuntime.awrap(u.get('Pages'));
                  case 28:
                    return (c = O.sent), (O.next = 31), regeneratorRuntime.awrap(c.value());
                  case 31:
                    return (a = O.sent), (O.next = 34), regeneratorRuntime.awrap(a.get('Kids'));
                  case 34:
                    return (f = O.sent), (O.next = 37), regeneratorRuntime.awrap(f.value());
                  case 37:
                    return (s = O.sent), (O.next = 40), regeneratorRuntime.awrap(s.getAt(0));
                  case 40:
                    return (l = O.sent), (O.next = 43), regeneratorRuntime.awrap(n.Filter.createURLFilter(r + 'my_stream.txt'));
                  case 43:
                    return (p = O.sent), (O.next = 46), regeneratorRuntime.awrap(n.FilterReader.create(p));
                  case 46:
                    return (h = O.sent), (v = new n.Filter('0')), (O.next = 50), regeneratorRuntime.awrap(n.Filter.createFlateEncode(v));
                  case 50:
                    return (y = O.sent), (O.next = 53), regeneratorRuntime.awrap(e.createIndirectStreamFromFilter(h, y));
                  case 53:
                    return (g = O.sent), (O.next = 56), regeneratorRuntime.awrap(l.put('Contents', g));
                  case 56:
                    return (O.next = 58), regeneratorRuntime.awrap(n.SecurityHandler.createDefault());
                  case 58:
                    return (
                      (d = O.sent).changeUserPasswordUString('test'),
                      console.log("Setting password to 'test'"),
                      d.setPermission(n.SecurityHandler.Permission.e_print, !1),
                      d.setPermission(n.SecurityHandler.Permission.e_extract_content, !0),
                      e.setSecurityHandler(d),
                      console.log('Saving modified file...'),
                      (O.next = 67),
                      regeneratorRuntime.awrap(e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 67:
                    (m = O.sent), saveBufferAsPDFDoc(m, 'secured.pdf'), (O.next = 76);
                    break;
                  case 71:
                    (O.prev = 71), (O.t0 = O.catch(4)), console.log(O.t0), console.log(O.t0.stack), (t = 1);
                  case 76:
                    return (O.prev = 76), console.log('Running Sample 2'), (b = e), (O.next = 81), regeneratorRuntime.awrap(b.initSecurityHandler());
                  case 81:
                    if (O.sent) {
                      O.next = 105;
                      break;
                    }
                    (x = !1), console.log("The password has been set to : 'test'"), (S = ['password', 'testy', 'test']), (w = 0);
                  case 86:
                    if (!(w < S.length)) {
                      O.next = 101;
                      break;
                    }
                    return (_ = S[w]), console.log("Trying password candidate: '" + _ + "'"), (O.next = 91), regeneratorRuntime.awrap(b.initStdSecurityHandlerUString(_));
                  case 91:
                    if (!O.sent) {
                      O.next = 97;
                      break;
                    }
                    return (x = !0), console.log('The password is correct'), O.abrupt('break', 101);
                  case 97:
                  ...
                  case 101:
                    ...
                    return console.log('Document authentication error...'), (t = 1), O.abrupt('return', t);
                  case 105:
                    return b.lock(), console.log('PDF document initialized and locked'), (O.next = 109), regeneratorRuntime.awrap(b.getSecurityHandler());
                  case 109:
                    return (P = O.sent), (O.t1 = console), (O.next = 113), regeneratorRuntime.awrap(P.isUserPasswordRequired());
                  case 113:
                    return (
                      (O.t2 = O.sent), (O.t3 = 'Document Open Password: ' + O.t2), O.t1.log.call(O.t1, O.t3), (O.t4 = console), (O.next = 119), regeneratorRuntime.awrap(P.isMasterPasswordRequired())
                    );
                  case 119:
                    return (
                      (O.t5 = O.sent),
                      (O.t6 = 'Permissions Password: ' + O.t5),
                      O.t4.log.call(O.t4, O.t6),
                      console.log('Permissions: '),
                      (O.t7 = console),
                      (O.next = 126),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_owner))
                    );
                  case 126:
                    return (
                      (O.t8 = O.sent),
                      (O.t9 = "\tHas 'owner' permissions: " + O.t8),
                      O.t7.log.call(O.t7, O.t9),
                      (O.t10 = console),
                      (O.next = 132),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_doc_open))
                    );
                  case 132:
                    return (
                      (O.t11 = O.sent),
                      (O.t12 = '\tOpen and decrypt the document: ' + O.t11),
                      O.t10.log.call(O.t10, O.t12),
                      (O.t13 = console),
                      (O.next = 138),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_extract_content))
                    );
                  case 138:
                    return (
                      (O.t14 = O.sent),
                      (O.t15 = '\tAllow content extraction: ' + O.t14),
                      O.t13.log.call(O.t13, O.t15),
                      (O.t16 = console),
                      (O.next = 144),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_doc_modify))
                    );
                  case 144:
                    return (
                      (O.t17 = O.sent),
                      (O.t18 = '\tAllow full document editing: ' + O.t17),
                      O.t16.log.call(O.t16, O.t18),
                      (O.t19 = console),
                      (O.next = 150),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_print))
                    );
                  case 150:
                    return (
                      (O.t20 = O.sent),
                      (O.t21 = '\tAllow printing: ' + O.t20),
                      O.t19.log.call(O.t19, O.t21),
                      (O.t22 = console),
                      (O.next = 156),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_print_high))
                    );
                  case 156:
                    return (
                      (O.t23 = O.sent),
                      (O.t24 = '\tAllow high resolution printing: ' + O.t23),
                      O.t22.log.call(O.t22, O.t24),
                      (O.t25 = console),
                      (O.next = 162),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_mod_annot))
                    );
                  case 162:
                    return (
                      (O.t26 = O.sent),
                      (O.t27 = '\tAllow annotation editing: ' + O.t26),
                      O.t25.log.call(O.t25, O.t27),
                      (O.t28 = console),
                      (O.next = 168),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_fill_forms))
                    );
                  case 168:
                    return (
                      (O.t29 = O.sent),
                      (O.t30 = '\tAllow form fill: ' + O.t29),
                      O.t28.log.call(O.t28, O.t30),
                      (O.t31 = console),
                      (O.next = 174),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_access_support))
                    );
                  case 174:
                    return (
                      (O.t32 = O.sent),
                      (O.t33 = '\tAllow content extraction for accessibility: ' + O.t32),
                      O.t31.log.call(O.t31, O.t33),
                      (O.t34 = console),
                      (O.next = 180),
                      regeneratorRuntime.awrap(P.getPermission(n.SecurityHandler.Permission.e_assemble_doc))
                    );
                  case 180:
                    return (
                      (O.t35 = O.sent),
                      (O.t36 = '\tAllow document assembly: ' + O.t35),
                      O.t34.log.call(O.t34, O.t36),
                      b.removeSecurity(),
                      (O.next = 186),
                      regeneratorRuntime.awrap(b.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized))
                    );
                  case 186:
                    (E = O.sent), saveBufferAsPDFDoc(E, 'not_secured.pdf'), console.log('done'), (O.next = 195);
                    break;
                  case 191:
                    (O.prev = 191), (O.t37 = O.catch(76)), console.log(O.t37.stack), (t = 1);
                  case 195:
