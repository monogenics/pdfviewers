  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Bt = function(t, n, r) {
          return !(Wt(t, (n = x(n, !0))) && S(r) && b(r, 'value')) || b(r, 'get') || b(r, 'set') || r.configurable || (b(r, 'writable') && !r.writable) || (b(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      xt || ((B.f = Vt), (V.f = Bt)),
          ...
          x
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (S(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return bt in r ? Rt(v, r) : jt.call(v, r);
                  (i = r), (p = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      var m,
        ...
        M = O || w(y),
        F = y ? (_ ? w('entries') : M) : void 0,
        R = ('Array' == n && P.entries) || O;
      if (
        (R && (b = s(R.call(new t()))) !== Object.prototype && b.next && (f(b, S, !0), e || 'function' == typeof b[l] || u(b, l, h)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : w('values'), keys: g ? M : w('keys'), entries: F }), d)) for (x in m) x in P || i(P, x, m[x]);
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(R) instanceof n && 0 !== O.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      I = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          x(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, C) || I(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : I(t, n, r)
        );
      },
      J = function(t, n) {
        x(t);
      ...
      tt = function(t) {
        for (var n, r = T(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = T(r ? G : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, w = '', S = 0, _ = 0; _ < m.length; _++) {
            ...
            var F = x.groups;
            if (h) {
              var R = [E].concat(O, P, p);
              void 0 !== F && R.push(F);
              var A = String(n.apply(void 0, R));
            } else A = y(E, p, P, O, F, n);
            P >= S && ((w += p.slice(S, P) + A), (S = P + E.length));
          }
          return w + p.slice(S);
        },
      ];
          ...
          function(t, n) {
            ...
            for (var b = 0, w = 0, S = []; w < p.length; ) {
              ...
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : w)), p.length)) === b) w = u(p, w, g);
                ...
                for (var P = 1; P <= E.length - 1; P++) if ((S.push(E[P]), S.length === x)) return S;
                w = b = _;
              }
            }
        ...
        return (
          ...
          (F.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: R(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    (e = window.PDFNet),
      ...
      window.addEventListener('documentLoaded', function() {
        e.initialize().then(function() {
          var t = !1,
            n = readerControl.docViewer,
            u = n.getDocument();
          u.getPDFDoc().then(function(c) {
            r && (n.getViewerElement().removeEventListener('mousedown', r), (o = []));
            var a = function(r) {
              if (!t) {
                t = !0;
                var a = readerControl.docViewer.getAnnotationManager();
                if (i.length > 0) {
                  for (var f = 0; f < i.length; f++) a.deleteAnnotation(i[f]);
                  i = [];
                }
                console.log('MouseClick X: ' + r.pageX + ', MouseClick Y: ' + r.pageY);
                var s = document.querySelector('.DocumentContainer'),
                  l = s.scrollTop,
                  p = s.scrollLeft,
                  h = { x: r.pageX + p, y: r.pageY + l },
                  v = n
                    .getDisplayModeManager()
                    .getDisplayMode()
                    .getSelectedPages(h, h).first;
                c.requirePage(v + 1)
                  .then(function() {
                    return u.extractPDFNetLayersContext();
                  })
                  .then(function(t) {
                    return (function(t, n, r, u, c, a, f) {
                      var s = c.getDisplayModeManager().getDisplayMode(),
                        l = c.getDocument(),
                        p = function(t, n, r, e, o) {
                          var u, c, s;
                          return regeneratorRuntime.async(function(p) {
                            for (;;)
                              switch ((p.prev = p.next)) {
                                case 0:
                                  (u = l.getViewerCoordinates(t, n, r)),
                                    (c = l.getViewerCoordinates(t, e, o)),
                                    (s = new a.RectangleAnnotation()).setPageNumber(t + 1),
                                    s.setRect(new a.Rect(u.x, Math.min(u.y, c.y), c.x, Math.max(u.y, c.y))),
                                    f.addAnnotation(s),
                                    i.push(s);
                                case 7:
                                case 'end':
                          ...
                          return regeneratorRuntime.async(function(c) {
                            for (;;)
                              switch ((c.prev = c.next)) {
                                case 0:
                                  (e = l.getViewerCoordinates(t, n, r)),
                                    (o = l.getViewerCoordinates(t, n, r)),
                                    (e.x -= 2),
                                    (e.y -= 2),
                                    (o.x += 2),
                                    (o.y += 2),
                                    (u = new a.RectangleAnnotation()).setPageNumber(t + 1),
                                    (u.FillColor = new a.Color(255, 255, 0, 1)),
                                    (u.StrokeColor = new a.Color(255, 0, 0, 1)),
                                    u.setRect(new a.Rect(e.x, Math.min(e.y, o.y), o.x, Math.max(e.y, o.y))),
                                    f.addAnnotation(u),
                                    i.push(u);
                                case 13:
                                case 'end':
                        ...
                        v = function(t, n, r, o) {
                          var i, u, c, a, s, l, p, v, y, g, d, m, x, b, w, S, _;
                            ...
                            for (;;)
                              switch ((E.prev = E.next)) {
                                case 0:
                                  (i = 0),
                                    t.length > 4e3
                                      ? console.log('Processing ' + t.length + ' points. This will take significant time.')
                                      : t.length > 500 && console.log('Processing ' + t.length + ' points. This may take some time.'),
                                    (u = 0);
                                case 3:
                                  if (!(u < t.length)) {
                                    E.next = 100;
                                  ...
                                  (c = void 0),
                                    ...
                                    (E.t0 = t[u]),
                                    (E.next =
                                      E.t0 === e.Element.PathSegmentType.e_moveto
                                        ? 22
                                        : E.t0 === e.Element.PathSegmentType.e_lineto
                                        ? 32
                                        : E.t0 === e.Element.PathSegmentType.e_cubicto
                                        ? 42
                                        : E.t0 === e.Element.PathSegmentType.e_rect
                                        ? 60
                                        : E.t0 === e.Element.PathSegmentType.e_closepath
                                        ? 95
                                        : 96);
                                  break;
                                case 22:
                                  return (c = n[i]), (a = n[++i]), ++i, (E.next = 28), regeneratorRuntime.awrap(r.mult(c, a));
                                case 28:
                                  return (x = E.sent), (E.next = 31), regeneratorRuntime.awrap(h(o, x.x, x.y));
                                case 31:
                                  return E.abrupt('break', 97);
                                case 32:
                                  return (c = n[i]), (a = n[++i]), ++i, (E.next = 38), regeneratorRuntime.awrap(r.mult(c, a));
                                case 38:
                                  return (x = E.sent), (E.next = 41), regeneratorRuntime.awrap(h(o, x.x, x.y));
                                case 41:
                                  return E.abrupt('break', 97);
                                case 42:
                                  return (c = n[i]), (a = n[++i]), (s = n[++i]), (l = n[++i]), (p = n[++i]), (v = n[++i]), ++i, (E.next = 56), regeneratorRuntime.awrap(r.mult(p, v));
                                case 56:
                                  return (x = E.sent), (E.next = 59), regeneratorRuntime.awrap(h(o, x.x, x.y));
                                case 59:
                                  return E.abrupt('break', 97);
                                case 60:
                                  return (
                                    (c = n[i]), (a = n[++i]), (d = n[++i]), (m = n[++i]), ++i, (l = a), (p = s = c + d), (y = c), (g = v = a + m), (E.next = 76), regeneratorRuntime.awrap(r.mult(c, a))
                                  );
                                case 76:
                                  return (b = E.sent), (E.next = 79), regeneratorRuntime.awrap(r.mult(s, l));
                                case 79:
                                  return (w = E.sent), (E.next = 82), regeneratorRuntime.awrap(r.mult(p, v));
                                case 82:
                                  return (S = E.sent), (E.next = 85), regeneratorRuntime.awrap(r.mult(y, g));
                                case 85:
                                  return (_ = E.sent), (E.next = 88), regeneratorRuntime.awrap(h(o, b.x, b.y));
                                case 88:
                                  return (E.next = 90), regeneratorRuntime.awrap(h(o, w.x, w.y));
                                case 90:
                                  return (E.next = 92), regeneratorRuntime.awrap(h(o, S.x, S.y));
                                case 92:
                                  return (E.next = 94), regeneratorRuntime.awrap(h(o, _.x, _.y));
                                case 94:
                                case 95:
                                case 96:
                                  return E.abrupt('break', 97);
                        ...
                        y = function(t, n, r, e, o, i, u) {
                          var c, a, f, s, l;
                          return regeneratorRuntime.async(function(n) {
                            for (;;)
                              switch ((n.prev = n.next)) {
                                case 0:
                                  return (n.next = 2), regeneratorRuntime.awrap(e.getDefaultMatrix());
                                case 2:
                                  return (c = n.sent), (n.next = 5), regeneratorRuntime.awrap(c.inverse());
                                case 5:
                                  return (c = n.sent), (n.next = 8), regeneratorRuntime.awrap(c.mult(i.x, i.y));
                                case 8:
                                  (a = n.sent), (f = t.length - 1);
                                case 10:
                                  if (!(f >= 0)) {
                                    n.next = 28;
                                    break;
                                  }
                                  if (((s = t[f]), !((l = s.bbox).x1 < a.x && l.x2 > a.x && l.y1 < a.y && l.y2 > a.y))) {
                                    n.next = 17;
                                    break;
                                  }
                                  console.log('bounding box detected'), (n.next = 18);
                                  break;
                                case 17:
                                  return n.abrupt('continue', 25);
                                case 18:
                                  return (n.next = 20), regeneratorRuntime.awrap(p(o, l.x1, l.y1, l.x2, l.y2));
                                case 20:
                                  if ('path' !== s.name) {
                                    n.next = 23;
                                    break;
                                  }
                                  return (n.next = 23), regeneratorRuntime.awrap(v(s.operators, s.points, s.ctm, o));
                                case 23:
                                  if (!u) {
                                    n.next = 25;
                                    break;
                                  }
                                  return n.abrupt('break', 28);
                                case 25:
                                  f--, (n.next = 10);
                                  break;
                                case 28:
                        ...
                        g = function t(n) {
                          var r, o, i, u, c, a, f, s, l, p, h, v;
                          return regeneratorRuntime.async(function(y) {
                            for (;;)
                              switch ((y.prev = y.next)) {
                                case 0:
                                  return (r = []), (y.next = 3), regeneratorRuntime.awrap(n.next());
                                case 3:
                                  o = y.sent;
                                case 4:
                                  if (null === o) {
                                  ...
                                  return (y.next = 7), regeneratorRuntime.awrap(o.isOCVisible());
                                case 7:
                                  if (((y.t0 = !y.sent), y.t0)) {
                                    y.next = 12;
                                    break;
                                  }
                                  return (y.next = 11), regeneratorRuntime.awrap(o.isClippingPath());
                                case 11:
                                  y.t0 = y.sent;
                                case 12:
                                  if (!y.t0) {
                                  ...
                                  return y.abrupt('continue', 56);
                                case 14:
                                  return (y.next = 16), regeneratorRuntime.awrap(o.getCTM());
                                case 16:
                                  return (i = y.sent), (y.next = 19), regeneratorRuntime.awrap(o.getType());
                                case 19:
                                  (u = y.sent),
                                    (c = void 0),
                                    (a = void 0),
                                    (y.t1 = u),
                                    (y.next = y.t1 === e.Element.Type.e_path ? 25 : y.t1 === e.Element.Type.e_image ? 36 : y.t1 === e.Element.Type.e_form ? 48 : 55);
                                  break;
                                case 25:
                                  return (y.next = 27), regeneratorRuntime.awrap(o.getPathData());
                                case 27:
                                  return (f = y.sent), (s = new Uint8Array(f.operators)), (l = new Float64Array(f.points)), (y.next = 32), regeneratorRuntime.awrap(o.getBBox());
                                case 32:
                                  return (c = y.sent), (a = { name: 'path', type: u, ctm: i, operators: s, points: l, bbox: c }), r.push(a), y.abrupt('break', 56);
                                case 36:
                                  return (y.next = 38), regeneratorRuntime.awrap(o.getBBox());
                                case 38:
                                  return (c = y.sent), (y.next = 41), regeneratorRuntime.awrap(o.getXObject());
                                case 41:
                                  return (p = y.sent), (y.next = 44), regeneratorRuntime.awrap(p.getObjNum());
                                case 44:
                                  return (h = y.sent), (a = { name: 'image', type: u, num: h, ctm: i, bbox: c }), r.push(a), y.abrupt('break', 56);
                                case 48:
                                  return n.formBegin(), (y.next = 51), regeneratorRuntime.awrap(t(n));
                                case 51:
                                  return (v = y.sent), (r = r.concat(v)), n.end(), y.abrupt('break', 56);
                                case 55:
                                  return y.abrupt('break', 56);
                                case 56:
                                  return (y.next = 58), regeneratorRuntime.awrap(n.next());
                                case 58:
                                  (o = y.sent), (y.next = 4);
                                  break;
                                case 61:
                                  return y.abrupt('return', r);
                                case 62:
                                case 'end':
                                  return y.stop();
                              }
                      ...
                      return e.runWithCleanup(function() {
                        var i, c, a, f, p, h, v, d, m, x, b;
                              ...
                              switch ((w.prev = w.next)) {
                                case 0:
                                  return (
                                    (w.prev = 1),
                                    (i = t).lock(),
                                    i.initSecurityHandler(),
                                    (c = !0),
                                    (a = u + 1),
                                    (f = s.windowToPage(r, u)),
                                    (p = l.getPDFCoordinates(u, f.x, f.y)),
                                    (w.next = 11),
                                    regeneratorRuntime.awrap(e.ElementReader.create())
                                  );
                                case 11:
                                  return (h = w.sent), (w.next = 14), regeneratorRuntime.awrap(e.ElementBuilder.create());
                                case 14:
                                  return w.sent, (w.next = 17), regeneratorRuntime.awrap(i.getPage(a));
                                case 17:
                                  return (v = w.sent), (w.next = 20), regeneratorRuntime.awrap(v.getDefaultMatrix());
                                case 20:
                                  return (d = w.sent), (w.next = 23), regeneratorRuntime.awrap(d.mult(p.x, p.y));
                                case 23:
                                  if (((p = w.sent), void 0 !== (m = o[u]))) {
                                    w.next = 36;
                                    break;
                                  }
                                  return (w.next = 28), regeneratorRuntime.awrap(i.getPage(a));
                                case 28:
                                  return (v = w.sent), (x = new e.OCGContext(n)), h.beginOnPage(v, x), (w.next = 33), regeneratorRuntime.awrap(g(h));
                                case 33:
                                  (m = w.sent), (o[u] = m), h.end();
                                case 36:
                                  return (w.next = 38), regeneratorRuntime.awrap(i.getPage(a));
                                case 38:
                                  return (v = w.sent), (x = new e.OCGContext(n)), (w.next = 42), regeneratorRuntime.awrap(y(m, 0, 0, v, u, p, c));
                                case 42:
                                  return (w.next = 44), regeneratorRuntime.awrap(e.SquareAnnot.create(i, e.Rect(10, 200, 800, 300)));
                                case 44:
                                  return (b = w.sent), (w.t0 = b), (w.next = 48), regeneratorRuntime.awrap(e.ColorPt.init(0, 0, 0));
                                case 48:
                                  (w.t1 = w.sent), w.t0.setColor.call(w.t0, w.t1, 3), b.refreshAppearance(), v.annotPushBack(b), (w.next = 58);
                                  break;
                                case 54:
                                  (w.prev = 54), (w.t2 = w.catch(1)), console.log(w.t2.stack);
                                case 58:
                                case 'end':
                                  return w.stop();
                              }
            ...
            (r = a), n.getViewerElement().addEventListener('mousedown', a);
          });
        });
      });
  },
