!(function(t) {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || R(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : R(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                E = a(m, p ? h : h.slice(w));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : w)), h.length)) === x) w = u(h, w, d);
              else {
  ...
  function(t, n) {
    ...
    !(function(t) {
      var n, e, o, i, u, c, a, f, s, l;
      regeneratorRuntime.async(function(h) {
        for (;;)
                  ...
                  return regeneratorRuntime.async(function(i) {
                    for (;;)
                      switch ((i.prev = i.next)) {
                        case 0:
                          return (t = new o.Color(200, 0, 0, 1)), (r = new o.Color(0, 200, 200, 1)), (i.next = 4), regeneratorRuntime.awrap(n.createDiffOptions());
                        case 4:
                          return (e = i.sent).setColorA(t), e.setColorB(r), e.setBlendMode(5), i.abrupt('return', e);
                        case 9:
                        case 'end':
                          return i.stop();
                      }
                  ...
                  return regeneratorRuntime.async(function(p) {
                    for (;;)
                      switch ((p.prev = p.next)) {
                        case 0:
                          return (p.next = 2), regeneratorRuntime.awrap(n.PDFDoc.create());
                        case 2:
                          return (o = p.sent).lock(), (p.next = 6), regeneratorRuntime.awrap(c());
                        case 6:
                          return (i = p.sent), (u = []), (p.next = 10), regeneratorRuntime.awrap(t.getPageIterator(1));
                        case 10:
                          return (a = p.sent), (p.next = 13), regeneratorRuntime.awrap(e.getPageIterator(1));
                        case 13:
                          (f = p.sent), (s = 0);
                        case 16:
                          return (p.next = 18), regeneratorRuntime.awrap(a.hasNext());
                        case 18:
                          if (!p.sent) {
                            p.next = 27;
                            break;
                          }
                          return (p.next = 21), regeneratorRuntime.awrap(a.current());
                        case 21:
                          (l = p.sent), (u[s] = [l]), s++;
                        case 24:
                          a.next(), (p.next = 16);
                        ...
                        case 27:
                          s = 0;
                        case 29:
                          return (p.next = 31), regeneratorRuntime.awrap(f.hasNext());
                        case 31:
                          if (!p.sent) {
                            p.next = 40;
                            break;
                          }
                          return (p.next = 34), regeneratorRuntime.awrap(f.current());
                        case 34:
                          (h = p.sent), (u[s] || (u[s] = [null])).push(h), s++;
                        case 37:
                          f.next(), (p.next = 29);
                          break;
                        case 40:
                          return (
                              ...
                              return regeneratorRuntime.async(function(a) {
                                for (;;)
                                  switch ((a.prev = a.next)) {
                                    case 0:
                                      return (
                                        (e = r(t, 2)), (u = e[0]), (c = e[1]), u || (u = new n.Page(0)), c || (c = new n.Page(0)), (a.next = 5), regeneratorRuntime.awrap(o.appendVisualDiff(u, c, i))
                                      );
                                    case 5:
                                    case 'end':
                                      return a.stop();
                            ...
                            (p.next = 43),
                            regeneratorRuntime.awrap(o.unlock())
                          );
                        case 43:
                          readerControl.loadDocument(o);
                        case 44:
                        case 'end':
                          return p.stop();
                      }
                  ...
                  return regeneratorRuntime.async(function(n) {
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          if ((t = i.getElementById('compareButton')).classList.contains('disabled')) {
                            n.next = 3;
                            break;
                          }
                  ...
                  return regeneratorRuntime.async(function(o) {
                    for (;;)
                      switch ((o.prev = o.next)) {
                        case 0:
                          return (o.next = 2), regeneratorRuntime.awrap(e.createDocument(t, {}));
                        case 2:
                          return (r = o.sent), (o.next = 5), regeneratorRuntime.awrap(r.getPDFDoc());
                        case 5:
                          (u[n] = o.sent), null !== u[1] && null !== u[0] && f();
                        case 7:
                        case 'end':
                          return o.stop();
                      }
                  ...
                  return regeneratorRuntime.async(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (e = window.CoreControls), (o = window.Annotations), e.enableFullPDF(!0), (t.next = 5), regeneratorRuntime.awrap(n.initialize());
                        case 5:
                        case 'end':
                          return t.stop();
                      }
                  ...
                  return regeneratorRuntime.async(function(e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (e.next = 2), regeneratorRuntime.awrap(l());
                        case 2:
                          return (e.next = 4), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../../samples/files/test_doc_1.pdf'));
                        case 4:
                          return (t = e.sent), (e.next = 7), regeneratorRuntime.awrap(n.PDFDoc.createFromURL('../../samples/files/test_doc_2.pdf'));
                        case 7:
                          return (r = e.sent), (e.next = 10), regeneratorRuntime.awrap(a(t, r));
                        case 10:
