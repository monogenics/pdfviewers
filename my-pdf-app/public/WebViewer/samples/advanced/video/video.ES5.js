!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (x = function(t) {
        ...
        o && (G(x, 'byteLength', '_l'), G(w, 'buffer', '_b'), G(w, 'byteLength', '_l'), G(w, 'byteOffset', '_o')),
        a(w[m], {
          getInt8: function(t) {
  ...
  function(t, n) {
    ...
    WebViewer({ path: 'lib', css: 'styles.css', disabledElements: ['searchButton', 'pageNavOverlay', 'viewControlsButton', 'panToolButton'] }, i).then(function(t) {
      var n, r, o, i, u;
          ...
          switch ((c.prev = c.next)) {
            case 0:
              return (
                ...
                (r = t.iframeWindow),
                (o = t.setHeaderItems),
                (i = n.getAnnotationManager()),
                '---- Insert commercial license key here after purchase ----',
                (c.next = 6),
                regeneratorRuntime.awrap(WebViewer.Video.registerDocument(t, '---- Insert commercial license key here after purchase ----'))
              );
            case 6:
                            ...
                            case 0:
                              return (
                                ...
                                (r = n
                                  ...
                                  .getAllAnnotations()),
                                (o.next = 4),
                                regeneratorRuntime.awrap(i.exportAnnotations({ links: !1, widgets: !1, annotList: r }))
                              );
                            case 4:
                              return (e = o.sent), (o.next = 7), regeneratorRuntime.awrap(t('video', e));
                            case 7:
                  ...
                  new Promise(function(n) {
                    fetch('/server/annotationHandler.js?documentId='.concat(t), { method: 'GET' }).then(function(r) {
                      200 === r.status
                        ...
                        : (console.warn('Something went wrong trying to load xfdf file /server/annotationHandler.js?documentId='.concat(t)), console.warn('Response status '.concat(r.status)), n(''));
                    });
                  }))
                    .then(function(t) {
                      return n.getAnnotationManager().importAnnotations(t);
                    })
                    .then(function() {
                      r.updateAnnotationsToTime(0);
                    });
                }),
                (u = !1),
                n.on('pageComplete', function(t, o) {
                  if (!u) {
                    u = !0;
                    var c = function(t) {
                    ...
                    o.appendChild(s);
                    var l = s.querySelector('#play'),
                      h = s.querySelector('#pause'),
                      p = s.querySelector('#volume'),
                      v = s.querySelector('#muted'),
                      d = s.querySelector('#progress'),
                      y = s.querySelector('.markers'),
                      g = s.querySelector('#current-time'),
                      m = s.querySelector('#tooltip'),
                      b = f.getElement(),
                      x = function(t) {
                        ...
                        t.forEach(function(t) {
                          if (t.startTime <= f.duration) {
                            ...
                            var e = Math.floor(r * d.clientWidth) - 1;
                            (n.style = 'left: '.concat(e, 'px')), y.appendChild(n);
                          }
                        });
                      };
                    i.on('annotationChanged', function() {
                      x(f.getAllAnnotations());
                    }),
                      x(f.getAllAnnotations()),
                      l.setAttribute('data-state', 'visible'),
                      h.setAttribute('data-state', 'hidden'),
                      b.addEventListener('play', function() {
                        l.setAttribute('data-state', 'hidden'), h.setAttribute('data-state', 'visible');
                      }),
                      b.addEventListener('pause', function() {
                        l.setAttribute('data-state', 'visible'), h.setAttribute('data-state', 'hidden');
                      }),
                      l.addEventListener('click', function() {
                        (b.paused || b.ended) && b.play();
                      }),
                      ...
                      b.addEventListener('volumechange', function(t) {
                        b.muted ? (p.setAttribute('data-state', 'hidden'), v.setAttribute('data-state', 'visible')) : (p.setAttribute('data-state', 'visible'), v.setAttribute('data-state', 'hidden'));
                      }),
                            ...
                            switch ((u.prev = u.next)) {
                              case 0:
                                return (
                                  ...
                                  (n = t.x),
                                  (r = t.width),
                                  (o = Array.from(w.getElementsByClassName('innerFrame')).filter(function(t) {
                                  ...
                                  (u.t3 = {}),
                                  (u.next = 9),
                                  regeneratorRuntime.awrap(f.extractFrames(i))
                                );
                              case 9:
                                (u.t4 = u.sent),
                                  (S = (0, u.t0)(u.t1, u.t2, u.t3, u.t4)),
                                  o.forEach(function(t) {
                                    var n = S[t.frameNumber];
                    ...
                    w.addEventListener('scroll', _.debounce(E, 250));
                    var O,
                      F = 770 / n.getZoom(),
                      P = f.getTotalFrames();
                    HyperList.create(w, {
                      ...
                      generate: function(t) {
                        ...
                        var o = c(
                          ...
                          i = S[n];
                        i && 'inprogress' !== i && e.appendChild(i), r.appendChild(e), r.appendChild(o);
                        var u = f.getFrameFromTime(b.currentTime);
                        return n === u && (r.setAttribute('data-state', 'selected'), (O = r)), r;
                      },
                    }),
                      s.appendChild(w),
                        ...
                        return regeneratorRuntime.async(function(n) {
                          for (;;)
                            switch ((n.prev = n.next)) {
                              case 0:
                                a.getVideo().updateAnnotationsToTime(b.currentTime),
                                  O && O.removeAttribute('data-state'),
                                  (t = f.getFrameFromTime(b.currentTime)),
                                  (O = r.document.getElementById('frame'.concat(t))) && O.setAttribute('data-state', 'selected');
                              case 5:
                              case 'end':
                                return n.stop();
                            }
                    ...
                    var A,
                      M = function(t) {
                        (b.currentTime = t), (d.value = b.currentTime), (g.innerHTML = ''.concat(f.getFormattedCurrentTime()));
                        var n = 100.5 * (f.getFrameFromTime(b.currentTime) - 1) - w.clientWidth / 2 + 46.25;
                        Math.abs(w.scrollLeft - n) < 800 ? w.scroll({ left: n, behavior: 'smooth' }) : (w.scrollLeft = n);
                      };
                    d.addEventListener('click', function(t) {
                      M(A);
                    }),
                      m.setAttribute('data-state', 'hidden'),
                      d.addEventListener('mousemove', function(t) {
                        var r = d.getBoundingClientRect().width,
                          e = ((t.offsetX * n.getZoom()) / r) * d.max;
                        (A = e), m.setAttribute('data-state', 'visible'), (m.style = 'left: '.concat(t.offsetX, 'px;')), (m.innerHTML = ''.concat(f.getFormattedTime(e)));
                      }),
                      d.addEventListener('mouseout', function(t) {
                        m.setAttribute('data-state', 'hidden');
                      }),
                      E();
                  }
