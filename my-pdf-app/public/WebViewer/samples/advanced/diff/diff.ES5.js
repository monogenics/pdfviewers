!(function(t) {
          ...
          b
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (x(e)) {
                  if (!(e instanceof H || 'ArrayBuffer' == (a = w(e)) || 'SharedArrayBuffer' == a)) return St in e ? It(v, e) : Tt.call(v, e);
                  (i = e), (p = Ot(r, n));
                  var d = e.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, d, y, g) {
      ...
      if (
        (I && (S = s(I.call(new t()))) !== Object.prototype && S.next && (f(S, x, !0), r || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
  ...
  function(t, n, e) {
    ...
    function C(t, n, e) {
      ...
      for (
        (t = P(t)) != t || t === E
          ...
          : ((r = F(I(t) / A)),
            t * (i = M(2, -r)) < 1 && (r--, (i *= 2)),
            (t += r + f >= 1 ? s / i : s * M(2, 1 - f)) * i >= 2 && (r++, (i /= 2)),
            r + f >= a ? ((o = 0), (r = a)) : r + f >= 1 ? ((o = (t * i - 1) * M(2, n)), (r += f)) : ((o = t * M(2, f - 1) * M(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, e, r, o, i) {
      ...
      for (var c = t[T]._b, a = u + t[N], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (S = function(t) {
        ...
        (w = function(t, n, e) {
          ...
          (this[T] = t), (this[N] = o), (this[j] = e);
        }),
        o && (U(S, 'byteLength', '_l'), U(w, 'buffer', '_b'), U(w, 'byteLength', '_l'), U(w, 'byteOffset', '_o')),
        a(w[m], {
          getInt8: function(t) {
    ...
    var r,
      ...
      T = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
    ...
    (function(t) {
      ...
      var e = (function(t) {
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, m) : ((t.__proto__ = m), a in t || (t[a] = 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
          ...
          (F.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: I(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = e), d;
            },
          }),
          t
        );
    ...
    !(function(t) {
      ...
      var n,
        ...
        T = function(n, e, r, o, i, c, a, f) {
          if (M[e]) {
            var s = x[O].documentContainer.querySelector('.canvas'.concat(n));
            if (s) {
              var l = function(e) {
        ...
        j = function(n, e, r) {
          var o = x[O].documentContainer.querySelector('.canvas'.concat(n));
          if (o) {
        ...
        Promise.all(d.map(k)).then(function() {
          ...
          return (
            ...
            n.docViewer.on('beginRendering', function() {
              ...
              (S[t] = n.docViewer.getViewportRegionRect(t)), b[t] && x[O].newDoc.cancelLoadCanvas(b[t]);
            }),
