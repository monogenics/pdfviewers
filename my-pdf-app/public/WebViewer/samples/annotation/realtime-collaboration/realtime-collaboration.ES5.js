    ...
    function R(t, n, r) {
      ...
      for (
        (t = P(t)) != t || t === E
          ...
          : ((e = F(I(t) / M)),
            t * (i = A(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + a >= 1 ? s / i : s * A(2, 1 - a)) * i >= 2 && (e++, (i /= 2)),
            e + a >= f ? ((o = 0), (e = f)) : e + a >= 1 ? ((o = (t * i - 1) * A(2, n)), (e += a)) : ((o = t * A(2, a - 1) * A(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
  ...
  function(t, n) {
    ...
    WebViewer(
      ...
      var n = t.docViewer,
        ...
        i = document.getElementById('copy');
      t.openElements(['notesPanel']);
      var u = !1;
      if ('http://localhost:3000' === window.location.origin) {
        var c = new XMLHttpRequest();
        (c.onreadystatechange = function() {
          4 === c.readyState && 200 === c.status && (o.value = 'http://'.concat(c.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          c.open('GET', '/ip', !0),
          c.send();
      } else (o.value = 'https://pdftron.com/samples/web/samples/annotation/realtime-collaboration/'), (o.value = 'https://pdfjs.express/samples/annotation/realtime-collaboration/');
      (i.onclick = function() {
        o.select(), document.execCommand('copy'), document.getSelection().empty();
      }),
        n.on('documentLoaded', function() {
          var t = null,
              ...
              return regeneratorRuntime.async(function(o) {
                for (;;)
                  switch ((o.prev = o.next)) {
                    case 0:
                      return (o.next = 2), regeneratorRuntime.awrap(e.importAnnotCommand(t.val().xfdf));
                    case 2:
                      if (((n = o.sent), !(r = n[0]))) {
                        o.next = 9;
                        break;
                      }
                      return (o.next = 7), regeneratorRuntime.awrap(r.resourcesLoaded());
                    case 7:
                      (r.authorId = t.val().authorId), e.redrawAnnotation(r);
                    case 9:
                    case 'end':
                      return o.stop();
                  }
            ...
            i = function(t) {
              ...
              e.importAnnotCommand(n);
            },
            c = function(t) {
              u || (e.setCurrentUser(t), window.alert('Welcome back '.concat(t)), (u = !0));
            },
            f = function() {
              var n,
                o = window.prompt('Welcome! Tell us your name :)');
              o && ((n = o), e.setCurrentUser(n), r.updateAuthor(t, { authorName: n }));
            };
          r.bind('onAuthStateChanged', function(e) {
            e ? ((t = e.uid), r.checkAuthor(t, c, f), r.bind('onAnnotationCreated', n), r.bind('onAnnotationUpdated', o), r.bind('onAnnotationDeleted', i)) : r.signInAnonymously();
          }),
            e.on('annotationChanged', function(n, o, i) {
              var u;
              return regeneratorRuntime.async(function(c) {
                for (;;)
                  switch ((c.prev = c.next)) {
                    ...
                    case 2:
                      return (c.next = 4), regeneratorRuntime.awrap(e.exportAnnotCommand());
                    case 4:
                      (u = c.sent),
                        n.forEach(function(n) {
                          var i = null;
                          'add' === o
                            ? (n.InReplyTo && (i = e.getAnnotationById(n.InReplyTo).authorId || 'default'),
                              t && (n.authorId = t),
                              r.createAnnotation(n.Id, { authorId: t, parentAuthorId: i, xfdf: u }))
                            : 'modify' === o
                            ? (n.InReplyTo && (i = e.getAnnotationById(n.InReplyTo).authorId || 'default'), r.updateAnnotation(n.Id, { authorId: t, parentAuthorId: i, xfdf: u }))
                            : 'delete' === o && r.deleteAnnotation(n.Id);
                        });
                    case 6:
                    case 'end':
                      return c.stop();
            ...
            e.setPermissionCheckCallback(function(n, r) {
              return r.authorId === t;
            });
        });
    });
