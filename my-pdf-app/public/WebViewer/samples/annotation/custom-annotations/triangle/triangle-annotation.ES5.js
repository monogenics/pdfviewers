    ...
    !(function(t) {
      ...
      t.TriangleAnnotationFactory = {
        initialize: function(e) {
          var o = function() {
            e.MarkupAnnotation.call(this), (this.Subject = 'Triangle'), (this[r] = n), (this.vertices = []);
            for (var t = 0; t < 3; ++t) this.vertices.push({ x: 0, y: 0 });
          };
          (o.prototype = new e.MarkupAnnotation()).elementName = 'triangle';
          var i = t.TriangleSelectionModelFactory.initialize(e);
          return (
            (o.prototype.selectionModel = i),
            (o.prototype.draw = function(t, n) {
              this.setStyles(t, n),
                t.beginPath(),
            ...
            (o.prototype.serialize = function(t, n) {
              var r = e.MarkupAnnotation.prototype.serialize.call(this, t, n);
              return r.setAttribute('vertices', e.XfdfUtils.serializePointArray(this.vertices, n)), r;
            }),
            (o.prototype.deserialize = function(t, n) {
              e.MarkupAnnotation.prototype.deserialize.call(this, t, n), (this.vertices = e.XfdfUtils.deserializePointArray(t.getAttribute('vertices'), n));
            }),
            o
          );
        },
